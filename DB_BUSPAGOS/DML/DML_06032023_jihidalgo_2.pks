 ...
 * Creacion de data para nuevo Canal de pago Banco Guayaquil Ecuanet
...
DECLARE
    ...
    CURSOR c_getdata IS
        select a.* from DB_BUSPAGOS.info_config_ent_rec_emp a where a.entidad_rec_empresa_id = (select d.ID_ENTIDAD_REC_EMPRESA from DB_BUSPAGOS.info_entidad_rec_empresa d where d.USUARIO_BUS = 'bancoguayaquil');
...
BEGIN
    ...
    'jihidalgo',
    null,
    (select ID_ENTIDAD_RECAUDADORA from DB_BUSPAGOS.admi_entidad_recaudadora where codigo = 'bcoguayaquilen'),
    (select ID_EMPRESA from DB_BUSPAGOS.admi_empresa where codigo = 'ecuanet'),
    'bcoguayaquilen',
    '6CMY69r63t1cUn+vKYFa6Q==',
    'bcoguayaquilen',
    '6CMY69r63t1cUn+vKYFa6Q==',
    null,
    null,
    ...
    LOOP
        ...
        INSERT INTO DB_BUSPAGOS.INFO_CONFIG_ENT_REC_EMP VALUES (
            ...
            'jihidalgo',
            NULL,
            (select n.id_entidad_rec_empresa from db_buspagos.info_entidad_rec_empresa n where n.usuario_bus = 'bcoguayaquilen'),
    ...
    AND ENTIDAD_REC_EMPRESA_ID = (select d.ID_ENTIDAD_REC_EMPRESA from DB_BUSPAGOS.info_entidad_rec_empresa d where d.USUARIO_BUS = 'bcoguayaquilen');
