...
AS
    /*
    * Documentaci�n para PROCEDIMIENTO 'CREAR_PLAN_MANTENIMIENTO'.
    ...
    */
    ...
    /*
    * Documentaci�n para FUNCION 'DEVUELVE_TAREA_ID_X_NOMBRE'.
    ...
    */
    ...
    /*
    * Documentaci�n para PROCEDIMIENTO 'CREAR_MANTENIMIENTO_Y_TAREAS'.
    * PROCEDIMIENTO QUE CREA LOS MANTENIMIENTOS QUE PERTENECEN A UN PLAN DE MANTENIMIENTO Y LA ASOCIACI�N CON LAS RESPECTIVAS TAREAS
    * EL PROCEDIMIENTO RECIBE LOS PARAMETROS:
