...
/** Trigger auditoria tabla INFO_HORAS_SOLICITUD_HISTORIAL **/
CREATE OR REPLACE TRIGGER DB_HORAS_EXTRAS.BEFORE_INFO_HORAS_SOLI_HIST
  BEFORE UPDATE ON DB_HORAS_EXTRAS.INFO_HORAS_SOLICITUD_HISTORIAL FOR EACH ROW
