...
/** Trigger auditoria tabla INFO_HORAS_SOLICITUD_DETALLE **/
CREATE OR REPLACE TRIGGER DB_HORAS_EXTRAS.BEFORE_INFO_HORAS_SOLI_DET
  BEFORE UPDATE ON DB_HORAS_EXTRAS.INFO_HORAS_SOLICITUD_DETALLE FOR EACH ROW
