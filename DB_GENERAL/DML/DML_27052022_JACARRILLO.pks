 ...
 *
 *Se actualizan las plantillas para la versión de documentos digitales(contratoMegadatos)
 **/
...
DECLARE
   plantilla_editada    CLOB := '<!DOCTYPE html>';
...
BEGIN
   ...
   ---------------contratoMegadatos---------------------
       ...
       DBMS_LOB.APPEND(plantilla_editada, '<!DOCTYPE html>
<html>
     <head>
       ...
       DBMS_LOB.APPEND(plantilla_editada, '
         <script>
 ...
 <div id="contenedor" class="col-width-100" style="$!fontSize">
         <table class="col-width-100">         
           <tr>     
             <td class="col-width-75" style="$!fontSize"><b>CONTRATO DE ADHESIÓN DE PRESTACIÓN DE SERVICIOS</b></td> 
           ...
           <tr style="$!verLeyenda">
            <td class="col-width-75" style="$!fontSize">FE DE ERRATAS: este contrato es emitido como corrección del contrato $!numeroContrato</td>
          </tr>
         ...
         <div style="$!fontSize">
             <span >
                 ...
                 parte el ABONADO, cuyos datos se datallan a contiuación:
             </span>
         </div>
         <!-- ============================== -->
         <!--        Datos del Cliente       -->
         ...
         <div id="contenedor" class="col-width-100" >
             ...
             <div id="row">
                 <div id="col" class="col-col-width-15"><b>Razon Social:</b></div>
                 <div id="col" class="col-width-50">
                     <span class="textPadding">$!razonSocial</span>
                 </div>
                 <div id="col" class="col-width-5"></div>
                 <div id="col" class="col-width-5"><b>RUC:</b></div>
                 <div id="col" class="col-width-29 labelGris">
                     <span class="textPadding">$!ruc</span>
                 </div>
             </div>
             <div id="row">
                 <div id="col" class="col-col-width-15"><b>Representante Legal:</b></div>
                 <div id="col" class="col-width-45 labelGris">
             ...
             <div id="row">
                 <div id="col" class="col-col-width-15"><b>Actividad Económica:</b></div>
       ...
       DBMS_LOB.APPEND(plantilla_editada, '
         ...
         <div id="contenedor" class="col-width-100" >
             ...
             <div id="row">
                ...
                <div id="col" class="col-width-5"></div>
                <div id="col" class="col-width-16"> <b>Coordenada Latitud: </b> </div>
             ...
             <div id="row">
                 ...
                 <div id="col" class="col-width-5"></div>
                 <div id="col" class="col-width-11"><b>Sector/Barrio: </b> </div>
                 <div id="col" class="col-width-19 labelGris">
             ...
             <div id="row">
                 <div id="col" class="col-width-20"> <b>Teléfono: </b> </div>
                 <div id="col" class="col-width-30 labelGris">
         ...
         <div style="$!fontSize">
             <span >
                 ...
                 las caracterósticas mínimas que requiere el equipo y otros que deben ser garantizados por el ABONADO constan en el anverso de este contrato.
             </span>
         </div>   
         <!-- ======================================== -->
         <!--        Datos del Servicio                -->
         ...
         <div id="contenedor" class="col-width-100" >
             <div id="row">
                 <div id="col" class="col-width-60">Los datos de instalación son los mismos que los datos del cliente?</div>
             ...
             <div id="row">
                 ...
                 <div id="col" class="col-width-11"><b>Sector/Barrio: </b> </div>
                 <div id="col" class="col-width-34 labelGris">
       ...
       DBMS_LOB.APPEND(plantilla_editada, '
        ...
        <!-- ============================== -->
        <div style="clear: both;margin: 70px;"><br/></div>
        <div class="labelBlock">SERVICIOS CONTRATADOS (ANEXO TÉCNICO)</div>
        <div style="width:36%; float:left; vertical-align:top;" >
            ...
            <table class="box-section-content col-width-100 borderTable print-friendly" style="border-collapse:collapse;border-spacing:0;">
                <tr>
                    <td class="col-width-60 " colspan="2">
                         ...
                         <div id="col" class="col-width-65">
                          ...
                          <div id="col" class="col-width-25" style="height: 40px;">
                            <div id="row">
                                <div id="col" >
                                    <div class="box">$!is2a1</div>2:1 
                                </div>
                            </div>
                            <div id="row">
                                <div id="col" >
                                    <div class="box">$!is1a1</div>1:1
                                </div>
                            </div>
                        </div>
                    </td>
            ...
            <table class="box-section-content col-width-100 borderTable" style="border-collapse:collapse; border-spacing:0; ">
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <div id="colCell" class="col-width-40 textRight">Descuento instalación:</div>
                        <div class="box">$!isDescInstalacion</div>
                        </div>

                    </td>
                    <td class="line-heightT textCenter" colspan="3">
                        <div id="col" class="col-width-100" style="height: 40px;">
                            <div id="row">
                                <div id="col" >
                                       Mensualidad promo:
        ...
        <div id="contenedor" class="col-width-100" style="height: 65px;">
            <div id="row">
                ...
                <div  class="clausulas col-width-90 fontSize" style="$!fontSize">
                    <ul class="labelGris textPadding" style="$!fontSize"> 
                    $!obsServicio
                    </ul>
                </div>
            </div>
        ...
        <div class="col-width-100" style="text-align: justify; $!fontSize">
            ...
            <div class="clausulas clausulasFont" >
                <ul>
                    ...
                    <li>Después de 300metros de cableado de fibra óptica de última milla, cada metro adicional de cableado de fibra óptica tendrá un valor adicional de $1,00+ impuestos de ley. Sujeto a factibilidad.</li>
            ...
            <div  class="clausulas clausulasFont" >
                <ul>
                    ...
                    <li>El cliente es responsable de la instalación y configuración interna de su red de área local, así como del control de la información y navegación que realice por internet MEGADATOS pone a disposición de los clientes un servicio integral de seguridad informática para reducir el potencial acceso a información que pueda herir la susceptibilidad o que pueda ser fuente de amenazas ciberneéticas. Este servicio puede ser activado por el cliente por un precio adicional según se indique en los planes de la página web de MEGADATOS y es responsable de su instalación en sus equipos terminales.</li>
                    ...
                    <li>MEGADATOS facturará y cobrará al ABONADO el servicio contratado en forma mensual basado en el ciclo de facturación en que haya sido definido.  Para ejecutar cancelaciones de servicio o downgrades, el ABONADO deberá notificar con 15 días de anticipación a la fecha de finalización de su ciclo de facturación.</li>
                    ...
                    <li>TIPO DE FACTURACIÓN:  <div class="box">$!isFactElectronica</div>Electrónica <div class="box"></div>Física  </li>
            ...
            <div id="row">
                <div id="colCell" class="col-width-50" style="text-align:center $!fontSize">
                    <div id="contenedor" class="col-width-100">
                        ...
                        <div id="row" >
                            <div id="colCell" class="col-width-25"></div>
                            <div id="colCell" style="$!fontSize" class="col-width-50"><hr></div>
                            <div id="colCell" class="col-width-25"></div>
                        </div>
                        <div id="row">
                            <div id="colCell" class="col-width-25"></div>
                            <div id="colCell" style="$!fontSize" class="col-width-50"><span>MEGADATOS</span><input id="inputfirma1" name="FIRMA_CONT_MD_FINAL_EMPRESA" type="text" value="" style="background-color:#fff; width:0.0em; margin-left:0.75em; border-style: hidden; opacity:0; border:none;$!fontSize" readonly/></div>
                            <div id="colCell" class="col-width-25"></div>
                        </div>
                    </div>
                </div><div id="colCell" class="col-width-50" style="text-align:center $!fontSize">
                    <div id="contenedor" class="col-width-100">
                        <div id="row" >
                            <div id="colCell" class="col-width-25"></div>
                            <div id="colCell" class="col-width-50" style="height:35px">
                        ...
                        <div id="row">
                            <div id="colCell" class="col-width-25"></div>
                            <div id="colCell" style="$!fontSize" class="col-width-50"><span>Firma del Cliente</span><input id="inputfirma2" name="FIRMA_CONT_MD_FINAL_CLIENTE" type="text" value="" style="background-color:#fff; width:0.0em; margin-left:0.75em; border-style: hidden; opacity:0; border:none;$!fontSize" readonly/></div>
                            <div id="colCell" class="col-width-25"></div>
                        </div>
                    </div>
                </div>
      ...
      UPDATE DB_FIRMAELECT.ADM_EMPRESA_PLANTILLA t SET t.HTML= plantilla_editada where t.COD_PLANTILLA = 'contratoMegadatos' AND ESTADO = 'Activo';
