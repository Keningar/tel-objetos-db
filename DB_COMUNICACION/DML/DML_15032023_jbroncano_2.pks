...
<ol>
<li>
El servicio contratado se encuentra en bits por segundo. El est'||chr(38)||'aacute;ndar para medir la velocidad del enlace es en bits por segundo y el de descarga de archivos es en bytes por segundo. (1 byte es igual a 8 bits)
</li>
<li>
...
<li>
El equipo WiFi est'||chr(38)||'aacute;ndar tiene una cobertura horizontal que depende de los obst'||chr(38)||'aacute;culos que existan (paredes, puertas, pisos), por lo cual no se puede garantizar distancias con obst'||chr(38)||'aacute;culos ya que depende de la estructura/arquitectura de la residencia del cliente. Su cobertura podr'||chr(38)||'iacute;a ser de hasta 15 metros sin obst'||chr(38)||'aacute;culos  y condiciones espectrales sin interferencias; sin embargo, la distancia de cobertura puede variar.
</li>
<li>
El tiempo de instalaci'||chr(38)||'oacute;n promedio del servicio es de 5 d'||chr(38)||'iacute;as h'||chr(38)||'aacute;biles, luego de haber firmado el contrato, haber entregado toda la documentaci'||chr(38)||'oacute;n y haber ingresado el contrato a nuestro sistema de gesti'||chr(38)||'oacute;n, sin embargo puede variar en funci'||chr(38)||'oacute;n de las condiciones t'||chr(38)||'eacute;cnicas y cobertura. No incluye obras civiles o cambios de acometida, la instalaci'||chr(38)||'oacute;n incluye 400m de fibra '||chr(38)||'oacute;ptica, el valor del metro de fibra '||chr(38)||'oacute;ptica adicional es de 1.00 USD + IVA.
</li>
<li>
NETLIFE ofrece soluciones de fibra '||chr(38)||'oacute;ptica invisible para residencias por un valor adicional.
</li>
<li>
Los equipos entregados son propiedad de NETLIFE y deber'||chr(38)||'aacute;n ser devueltos en las oficinas de NETLIFE al finalizar el contrato, caso contrario los equipos ser'||chr(38)||'aacute;n facturados y cobrados al cliente.
</li>
<li>
El cliente acepta que para salvaguardar la integridad de la red y evitar el SPAM el puerto 25 est'||chr(38)||'aacute; bloqueado en servicios HOME.
</li>
<li>
El cliente conoce y acepta que la velocidad del plan contratado puede entregarse mediante conexi'||chr(38)||'oacute;n al'||chr(38)||'aacute;mbrica al equipo WiFi est'||chr(38)||'aacute;ndar ofrecido por NETLIFE. En el caso de realizar la conexi'||chr(38)||'oacute;n en forma inal'||chr(38)||'aacute;mbrica por WiFi, la tasa de transferencia llega hasta 30Mbps considerando las condiciones del punto 3. NETLIFE ofrece por un valor adicional SMARTWIFI que permite alcanzar velocidades superiores para planes de Ultra Alta Velocidad.
</li>
...
<li>
En caso de no haber pagado el servicio en el plazo establecido, el servicio podr'||chr(38)||'aacute; ser     suspendido en cualquier momento.
</li>
...
<ol>
<li>
Usted puede comunicarse con nuestro centro de atenci'||chr(38)||'oacute;n al cliente 1-700-638-543, 3920000 o al correo electr'||chr(38)||'oacute;nico <a href="mailto:info@netlife.net.ec" target="_top"> info@netlife.net.ec</a> las 24 horas del d'||chr(38)||'iacute;a, los 365 d'||chr(38)||'iacute;as del a'||chr(38)||'ntilde;o.
</li>
