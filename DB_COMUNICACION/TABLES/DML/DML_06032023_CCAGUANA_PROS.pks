...
SET SERVEROUTPUT ON ;
  ...
  CURSOR C_VerificarExistencia (Cv_Codigo VARCHAR2,Cn_EmpresaCod  NUMBER ,Cv_Estado VARCHAR2) IS 
   SELECT t.ID_PLANTILLA  FROM DB_COMUNICACION.ADMI_PLANTILLA t
...
BEGIN 
    ...
    Lv_Nombre  := 'Consentimiento Informado de Prospecto'; 
    Lv_Codigo  := 'PROSPECTO_INFOR'; 
    Lv_Modulo :=  'COMERCIAL';
    Lv_EmpresaCod := '33';  
    ...
    @media screen and (max-width: 599px) {
        ...
        <table border="0" width="100%"><tbody><tr><td align="center" valign="top" style="background-color:#ffffff"><!--[if mso]>
              ...
              <h3 style="margin:0 0 6.6px;mso-ansi-font-size:22px;color:#333333;font-family:&#39;Trebuchet MS&#39;,&#39;Lucida Grande&#39;,&#39;Lucida Sans Unicode&#39;,&#39;Lucida Sans&#39;,Tahoma,sans-serif;font-size:16px;line-height:35.2px;mso-line-height-alt:36px;text-align:center;padding:0;font-style:normal;font-weight:normal">Est&aacute;s a un paso de formar parte de la comunidad de Ecuanet. Agradecemos confirmes tu consentimiento para el env&iacute;o de informaci&oacute;n comercial por medios digitales.
              </h3>
            </td>
          </tr></tbody></table></div>
                    </td>
