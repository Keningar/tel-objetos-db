...
BEGIN
  ...
  VALUES (DB_COMUNICACION.SEQ_ADMI_PLANTILLA.NEXTVAL,'regularización de cliente', 'REGULARIZA_CLI', 'COMERCIAL', '', 'Activo', SYSDATE, 'epin', '18');
...
<h3 style="margin:0 0 6.6px;mso-ansi-font-size:20px;color:#333333;font-family:&#39;Trebuchet MS&#39;,&#39;Lucida Grande&#39;,&#39;Lucida Sans Unicode&#39;,&#39;Lucida Sans&#39;,Tahoma,sans-serif;font-size:20px;line-height:35.2px;mso-line-height-alt:36px;margin-bottom:0;text-align:center;padding:0;font-style:normal;font-weight:normal">Hola {{nombreCliente}}, nos tomamos muy en serio el cuidarte, y nos encanta compartir contigo informaci&oacute;n que sentimos te va a interesar, por esta raz&oacute;n necesitamos que nos ayudes aceptando las opciones en las que quieres ser parte de nosotros para estar siempre actualizado con todo lo que ocurre en el mundo de Netlife.
  </h3>
        </td>
  ...
  UPDATE DB_COMUNICACION.ADMI_PLANTILLA t SET t.PLANTILLA = plantilla_links WHERE t.CODIGO = 'REGULARIZA_CLI' AND t.ESTADO = 'Activo';
  --------------------
