CREATE   OR REPLACE VIEW "DB_FINANCIERO"."VISTA_CLIENTES_REPORTE_BURO" ("ID_PERSONA", "TIPO_IDENTIFICACION", "TIPO_DOCUMENTO", "IDENTIFICACION_CLIENTE", "NOMBRE_CLIENTE", "SALDO", "ESTADO", "EMPRESA_COD") AS 
