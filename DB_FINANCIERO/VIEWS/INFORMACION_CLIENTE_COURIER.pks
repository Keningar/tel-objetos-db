CREATE   OR REPLACE VIEW "DB_FINANCIERO"."INFORMACION_CLIENTE_COURIER" ("ID_PUNTO", "LATITUD", "LONGITUD", "IDENTIFICACION_CLIENTE", "ID_PERSONA", "NOMBRE_OFICINA", "CLIENTE", "DESCRIPCION_CLIENTE", "CONTRATO", "DIRECCION", "DIRECCION_PTO", "NOMBRE_TIPO_NEGOCIO", "DESCRIPCION_BANCO", "DESCRIPCION_CUENTA", "DESCRIPCION_FORMA_PAGO", "CIUDAD") AS 
  select 
ip.id_punto,
ip.latitud,
ip.longitud,
