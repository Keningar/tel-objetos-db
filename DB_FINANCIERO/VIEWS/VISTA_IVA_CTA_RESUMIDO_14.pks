CREATE FORCE EDITIONABLE VIEW "DB_FINANCIERO"."VISTA_IVA_CTA_RESUMIDO_14" ("PUNTO_ID", "TOTAL_BIENES", "TOTAL_SERVICIOS", "TOTAL_IVA_SERVICIOS", "TOTAL_IVA_BIENES") AS 
  SELECT ESTADO_CUENTA.PUNTO_ID, 
    ...
    FROM(
	    ...
	    WHERE DB_FINANCIERO.INFO_DOCUMENTO_FINANCIERO_CAB.estado_impresion_fact NOT IN ('Inactivo', 'Anulado', 'Anulada', 'Rechazada', 'Rechazado', 'Pendiente', 'Aprobada', 'Eliminado', 'ErrorGasto', 'ErrorDescuento', 'ErrorDuplicidad') 
