CREATE FORCE EDITIONABLE VIEW "DB_FINANCIERO"."VISTA_ESTADO_CTA_RESUMIDO_12" ("PUNTO_ID", "SALDO") AS 
  SELECT ESTADO_CUENTA.PUNTO_ID, SUM(ESTADO_CUENTA.VALOR_TOTAL) SALDO
    FROM (
            ...
            WHERE DB_FINANCIERO.INFO_DOCUMENTO_FINANCIERO_CAB.estado_impresion_fact NOT IN ('Inactivo', 'Anulado','Anulada','Rechazada','Rechazado',
                                                                                            'Pendiente','Aprobada','Eliminado','ErrorGasto',
            ...
            WHERE DB_FINANCIERO.INFO_DOCUMENTO_FINANCIERO_CAB.estado_impresion_fact NOT IN ('Inactivo', 'Anulado','Anulada','Rechazada','Rechazado',
              ...
              AND REFERENCIA_DOCUMENTO_ID IN (
                                                ...
                                                WHERE idfc.estado_impresion_fact NOT IN ('Inactivo', 'Anulado','Anulada','Rechazada','Rechazado',
                                                                                         'Pendiente','Aprobada','Eliminado','ErrorGasto', 
                                                                                         'ErrorDescuento','ErrorDuplicidad') 
            ...
            WHERE ipc.estado_pago NOT IN ('Inactivo', 'Anulado','Asignado')
              ...
              AND( 
                    ipd.REFERENCIA_ID IN (
                                            ...
                                            WHERE idfc2.estado_impresion_fact NOT IN ('Inactivo', 'Anulado','Anulada','Rechazada','Rechazado',
                                                                                      'Pendiente','Aprobada','Eliminado','ErrorGasto',
                                                                                      'ErrorDescuento','ErrorDuplicidad') 
