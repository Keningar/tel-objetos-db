CREATE EDITIONABLE PACKAGE                             FNCK_CAMBIO_FORMA_PAGO AS
...
/**
  ...
  *
  * Funci�n que permite obtener la permanencia m�nima desde la fecha de activaci�n del servicio.
...
/**
  * Documentaci�n para la funci�n 'F_GET_VALOR_INST_PROMO'.
  *
...
/**
  * Documentaci�n para la funci�n 'F_GET_PORCENTAJE_MAPEO_PROMO'
  *
  * Funci�n que permite obtener el porcentaje de descuento del servicio con el tipo de promoci�n enviados como par�metro.
  * El tipo de promoci�n utilizado para instalaci�n es 'PROM_INS'
  * @param  Fv_TipoPromocion   IN  DB_COMERCIAL.INFO_DETALLE_MAPEO_PROMO.TIPO_PROMOCION%TYPE    recibe el tipo de promoci�n.
...
/**
  * Documentaci�n para la funci�n 'F_GET_FE_ACT_INT'
  *
  * Funci�n que permite obtener  la fecha de activaci�n del servicio de internet.
  * @param  Fn_IdPunto   IN DB_COMERCIAL.INFO_PUNTO.ID_PUNTO%TYPE  recibe el id del punto.
  * @return VARCHAR2  
  * @author Edgar Holgu�n <eholguin@telconet.ec>
  * @version 1.0 18-12-2019
...
/**
  * Documentaci�n para la funci�n 'GET_FECHA_ACTIVACION'
  *
  * Funci�n que permite obtener  la fecha de activaci�n del servicio.
  * @param  Fn_IdServicio   IN DB_COMERCIAL.INFO_SERVICIO.ID_SERVICIO%TYPE  recibe el id del servicio.
  * @return VARCHAR2  
  * @author Edgar Holgu�n <eholguin@telconet.ec>
  * @version 1.0 18-12-2019
...
FUNCTION GET_FECHA_ACTIVACION(Fn_IdServicio IN DB_COMERCIAL.INFO_SERVICIO.ID_SERVICIO%TYPE) RETURN  VARCHAR2;
  ...
  */
  ...
  /*
  * Documentaci�n para TYPE 'T_HistFormaPago'.
  * Record para almacenar la data enviada al BULK.
  * @author Edgar Holgu�n <eholguin@telconet.ec>
  ...
  */
  ...
  /**
  * Documentaci�n para el procedimiento P_GET_PTOS_CAMBIO_FORMA_PAGO
  *
  ...
  */
  ...
  /**
  * Documentaci�n para el procedimiento P_NOTIF_CAMBIO_FORMA_PAGO
  *
...
/**
  * Documentaci�n para la funci�n 'F_GET_MIN_FE_ACT_INT'
  *
  * Funci�n que permite obtener  la fecha m�nima de activaci�n del servicio de internet.
  * @param  Fn_IdPunto   IN DB_COMERCIAL.INFO_PUNTO.ID_PUNTO%TYPE  recibe el id del punto.
  * @return VARCHAR2  
  * @author Edgar Holgu�n <eholguin@telconet.ec>
  * @version 1.0 18-12-2019
...
/**
  ...
  *
  * Funci�n que permite obtener  la forma actual del contrato enviado como par�metro.
  * @param  Fn_IdContrato   IN   DB_COMERCIAL.INFO_CONTRATO.ID_CONTRATO%TYPE  recibe el id del contrato.
  * @return VARCHAR2  
  * @author Edgar Holgu�n <eholguin@telconet.ec>
...
/**
  * Documentaci�n para la funci�n 'F_GET_HIST_TRASL_CRS'
  *
  * Funci�n que permite obtener el id del historial por traslado o CRS con feActivaci�n del servicio or�gen del punto enviado como par�metro.
  * @param  Fn_IdPunto   IN   DB_COMERCIAL.INFO_PUNTO.ID_PUNTO%TYPE  recibe el id del punto destino.
  * @return VARCHAR2   Retorna el origen (T-traslado o CRS- Cambio de raz�n social concatenado con el id del punto de or�gen)
  * @author Edgar Holgu�n <eholguin@telconet.ec>
...
/**
  * Documentaci�n para la funci�n 'F_GET_PTO_ORIGEN_TRASLADO'
  *
  * Funci�n que permite obtener el id del punto or�gen proveniente de un traslado.
...
/**
  * Documentaci�n para la funci�n 'F_GET_PTO_ORI_CRS_LOGIN'
  *
  * Funci�n que permite obtener el id del punto or�gen proveniente de un CRS por login.
  * @param  Fn_IdPuntoDestino   IN   DB_COMERCIAL.INFO_PUNTO.ID_PUNTO%TYPE  recibe el id del punto destino.
  * @return NUMBER   Retorna el id del punto  origen.
  * @author Edgar Holgu�n <eholguin@telconet.ec>
  * @version 1.0 20-02-2020
...
/**
  * Documentaci�n para la funci�n 'F_GET_PTO_ORI_CRS_TRAD'
  *
  * Funci�n que permite obtener el id del punto or�gen proveniente de un CRS tradicional.
  * @param  Fn_IdPuntoDestino   IN   DB_COMERCIAL.INFO_PUNTO.ID_PUNTO%TYPE  recibe el id del punto destino.
  * @return NUMBER   Retorna el id del punto  origen.
  * @author Edgar Holgu�n <eholguin@telconet.ec>
  * @version 1.0 20-02-2020
...
FUNCTION F_GET_PTO_ORI_CRS_TRAD(Fn_IdPuntoDestino   IN DB_COMERCIAL.INFO_PUNTO.ID_PUNTO%TYPE)
  ...
  *
  * Funci�n que permite obtener el n�mero de meses activo de un servicio (Entero menor).
  * @param  Fn_IdServicio   IN DB_COMERCIAL.INFO_SERVICIO.ID_SERVICIO%TYPE  recibe el id del servicio.
  * @return NUMBER
  * @author Edgar Holguin <eholguin@telconet.ec>
...
/**
  * Documentaci�n para la funci�n 'F_GET_DCTO_ULT_FORMA_PAG'
  *
  * Funci�n que permite obtener el porcentaje de descuento aplicado en el �ltimo cambio de forma de pago.
  * El tipo de promoci�n utilizado para instalaci�n es 'PROM_INS'
  * @param  Fn_IdContrato   IN   DB_COMERCIAL.INFO_CONTRATO.ID_CONTRATO%TYPE    recibe el id del contrato.
  * @return NUMBER  
  * @author Edgar Holgu�n <eholguin@telconet.ec>
...
/**
  * Documentaci�n para la funci�n 'F_GET_PORCENTAJE_DCTO_INST'.
  *
  * Funci�n que permite obtener el porcentaje de descuento de instalaci�n a aplicar en el cambio de forma de pago.
  * @param  Fv_EmpresaCod         IN  DB_COMERCIAL.INFO_EMPRESA_GRUPO.COD_EMPRESA%TYPE  recibe el c�digo de la empresa.
  * @param  Fn_IdPunto            IN  DB_COMERCIAL.INFO_PUNTO.ID_PUNTO%TYPE             recibe el id del punto.
  * @param  Pn_IdServicio         IN DB_COMERCIAL.INFO_SERVICIO.ID_SERVICIO%TYPE        recibe el id del servicio.
  * @param  Fn_IdContrato         IN DB_COMERCIAL.INFO_CONTRATO.ID_CONTRATO%TYPE        recibe el id del contrato.
...
/**
  * Documentaci�n para la funci�n 'F_GET_PORCENTAJE_DCTO_DEST'.
  *
  * Funci�n que permite obtener el porcentaje de descuento testativo para la forma de pago destino.
  * @param  Fv_EmpresaCod         IN  DB_COMERCIAL.INFO_EMPRESA_GRUPO.COD_EMPRESA%TYPE  recibe el c�digo de la empresa.
  * @param  Fn_IdPunto            IN  DB_COMERCIAL.INFO_PUNTO.ID_PUNTO%TYPE             recibe el id del punto.
  * @param  Pn_IdServicio         IN DB_COMERCIAL.INFO_SERVICIO.ID_SERVICIO%TYPE        recibe el id del servicio.
  * @param  Fn_IdContrato         IN DB_COMERCIAL.INFO_CONTRATO.ID_CONTRATO%TYPE        recibe el id del contrato.
...
/**
  * Documentaci�n para la funci�n 'P_GET_PORCENTAJE_DCTO_INST'.
  *
...
CREATE EDITIONABLE PACKAGE BODY                                           FNCK_CAMBIO_FORMA_PAGO AS
...
IS
  ...
  CURSOR C_GET_HISTORIAL(Cn_IdPunto DB_COMERCIAL.INFO_PUNTO.ID_PUNTO%TYPE) IS
    ...
    LEFT JOIN DB_COMERCIAL.ADMI_PRODUCTO AP               ON AP.ID_PRODUCTO  = IPD.PRODUCTO_ID
    WHERE (UPPER (ISH.ACCION)      = 'FEORIGSERVICIOTRASLADADO'
           OR  UPPER (ISH.OBSERVACION) LIKE 'SE CRE� EL SERVICIO POR TRASLADO DEL LOGIN%'
           OR  UPPER (ISH.ACCION)  = 'FEORIGENCAMBIORAZONSOCIAL'
           OR  UPPER (ISH.ACCION)  = 'FEORIGSERVICIONETLIFECAM'
           OR  UPPER (ISH.OBSERVACION) LIKE 'SE CONFIRM� EL SERVICIO POR CAMBIO DE RAZ�N SOCIAL%'
           OR  UPPER (ISH.OBSERVACION) LIKE 'FECHA INICIAL DE SERVICIO NETLIFECAM%'
           OR  UPPER (ISH.OBSERVACION) LIKE 'FECHA INICIAL DE SERVICIO POR CAMBIO DE RAZ�N SOCIAL%'           
...
BEGIN
  ...
  IF UPPER (Lr_InfoServHist.ACCION) = 'FEORIGSERVICIOTRASLADADO' OR 
     ...
     (INSTR(UPPER(Lr_InfoServHist.OBSERVACION),'SE CRE� EL SERVICIO POR TRASLADO DEL LOGIN') <> 0)THEN
    Lv_Origen := 'Traslado';
  ELSIF UPPER (Lr_InfoServHist.ACCION) = 'FEORIGENCAMBIORAZONSOCIAL' OR
        UPPER (Lr_InfoServHist.ACCION) = 'FEORIGSERVICIONETLIFECAM'  OR 
       (INSTR(UPPER(Lr_InfoServHist.OBSERVACION),'CAMBIO DE RAZ�N SOCIAL') <> 0) OR 
...
-- Porcentage promocional vigente forma de pago destino
 ...
 Ln_PorcentDctoFormaPagDestino := DB_FINANCIERO.FNCK_CAMBIO_FORMA_PAGO.F_GET_PORCENTAJE_DCTO_DEST ( Fv_EmpresaCod,
  ...
  -- Porcentaje Dcto forma de pago or�gen
