CREATE OR REPLACE package DB_FINANCIERO.FNKG_VAR is
  /**
  * Documentacion para Packages FNKG_VAR
  * Packages que contendar todas las constantes que se requiera usar para evitar usar codigo fijo en los querys
  *
