...
AS
  ...
  /*
  * Documentación para TYPE 'TypePlantillaCab'.
  ...
  */
  ...
  /*
  * Documentación para TYPE 'lst_map_idMigracionType'.
  * Record que me permite almancernar mapeo de IdMigracion para Compañia 33 y 18
  */
  type lst_map_idMigracionType is table of number index by pls_integer;

  /*
  * Documentación para TYPE 'TypeoOficinas'.
  ...
  */
  ...
  /*
  * Documentación para TYPE 'TypeProductosFacturados'.
  ...
  */
  ...
  /*
  * Documentación para TYPE 'TypeProductosFacturadosTab'.
  ...
  */
  ...
  /*
  * Documentación para TYPE 'TypeOficinasFacturados'.
  ...
  */
  ...
  /*
  * Documentación para TYPE 'TypeOficinasFacturadosTab'.
  * Table para manejo de los arreglos
  */
  TYPE TypeOficinasFacturadosTab IS TABLE OF TypeOficinasFacturados INDEX BY PLS_INTEGER;

  /*
  * Documentación para TYPE 'TypeInfoDocumento'.
  ...
  */
  ...
  /*
  * Documentación para TYPE 'TypePlantillaDet'.
  ...
  */
  ...
  /*
  * Documentación para TYPE 'TypeTotalizado'.
  ...
  */
  ...
  /*
  * Documentación para TYPE 'TypeIdDocumento'.
  ...
  */
  ...
  /*
  * Documentación para TYPE 'TypeIdDocumentoTab'.
  ...
  */
  ...
  /*
  * Documentación para TYPE 'TypeDocumentosFacturados'.
  ...
  */
  ...
  /*
  * Documentación para TYPE 'lstMigraArcgalType'.
  * Table para manejo de los arreglos
  */
  ...
  */
  ...
  /**
    ...
    * Pv_Anio       IN  VARCHAR2                                          Año de asiento contable,
  ...
  */
  ...
  /**
    ...
    * @version 1.3 14-08-2018 - Se corrige query dinámico que hace referencia a las estructuras configuración contable que fueron quitadas.
    *
    * @author Luis Lindao <llindao@telconet.ec>
    * @version 1.4 20-08-2018 - Se corrige query dinámico que recupera datos de facturas anuladas, se cambio a constante el ID_PRODUCTO
    *                           sin considerarlo como variable en el string que guarda el query dinamico
    *
    * @author Luis Lindao <llindao@telconet.ec>
    * @version 1.5 07-11-2018 - Se corrige query dinámico para anulacion de documentos, sentencia order by sin separar genera error de sintaxis
*/
  ...
  /**
    ...
    *
    * @author Luis Lindao <llindao@telconet.ec>
    * @version 1.2 21-06-2018 - Se modifica usar query dinámico que permita filtrar información por fecha DATE o TIMESTAMP
    *
    * Pv_CodEmpresa  IN      VARCHAR2,      Código de empresa
  ...
  */
  ...
  /**
    ...
    *
    * @author Luis Lindao <llindao@telconet.ec>
    * @version 1.2 05-03-2018 - Se modifica para eliminar código en comentario.
  */
  ...
  */
   ...
   * Permite procesar la información a contabilizar
   ...
   * @version 1.2 17-03-2017 - Se quita la función SUBSTR de las columnas 'Lr_MigraArcgae.NO_ASIENTO' para que el número de asiento generado coincida
   *                           con el formato ingresado en la 'DB_FINANCIERO.ADMI_PLANTILLA_CONTABLE_CAB', y se pueda realizar la comparación de lo
   ...
   * @version 1.3 15-08-2017 - Se modifica para usar los procedimientos insert de repositorio migración de NAF
   * también se modifica para mejorar el control de errores
   *
   * @author llindao <llindao@telconet.ec>
   * @version 1.4 04-03-2018 - Se modifica corregir asignación de valor campo referencial cuando se contabiliza la linea PORTADOR.
   *
   * @author llindao <llindao@telconet.ec>
   * @version 1.5 21-06-2018 - Se modifica validar cuadre de asiento y ajustar automáticamente en base a plantilla de ajuste por redondeo
   * 
   * @author eareyesv <eareyesv@telconet.ec>
   * @version 1.6 08-05-2023 - SE corrige bug en el cursor cObtenerSecuenciasDocs, para evitar que obtenga secuenciales registrados en la tabla INFO_DOCUMENTO_HISTORIAL, se agrega condicional para evitarla ejecución del procedimiento almacenado 'FNCK_FACTURACION_DETALLES.P_FACTURACION_DETALLE' cuando el mes a procesar sea diferente al mes actual.
   *
   */
   ...
   *
   * @author Luis Lindao <llindao@telconet.ec>
   * @version 1.5 12-11-2018 - Se corrige parametro que genera query dinámico para considerar filtro PRODUCTO_NC pues se duplica detalle contable
   *
   * @author Luis Lindao <llindao@telconet.ec>
   * @version 1.6 14-11-2018 - La corrección anterior se aplicó a contabilización masiva de facturas, se agrega corrección en anulación nota crédito
   */
...
/**
   ...
   * registrado en la tabla INFO_DOCUMENTO_HISTORIAL,para que se pueda realizar el proceso de contabilización.
   *
  ...
  *            Pv_Cia_Origen   IN naf47_tnet.migra_arcgae.no_cia%type      Compañia Origen
  *            Pv_Cia_Destino  IN naf47_tnet.migra_arcgae.no_cia%type      Compañia Destino
...
CREATE OR REPLACE PACKAGE BODY DB_FINANCIERO.FNKG_CONTABILIZAR_FACT_NC AS
  ...
  /**
    ...
    *
    * @Param Pv_CodEmpresa           DB_COMERCIAL.INFO_EMPRESA_GRUPO.COD_EMPRESA%TYPE                        Código de Empresa
 ...
 END;
  ...
  BEGIN
    ...
    Lv_consulta := Lv_consulta||'AND APD.VALOR2 = IDFC.TIPO_DOCUMENTO_ID)'||CHR(10);  -- Estados impresión facturas
    --
    Lv_consulta := Lv_consulta||'AND EXISTS (SELECT NULL'||CHR(10);
    Lv_consulta := Lv_consulta||'FROM DB_GENERAL.ADMI_PARAMETRO_DET APD,'||CHR(10);
    Lv_consulta := Lv_consulta||'DB_GENERAL.ADMI_PARAMETRO_CAB APC'||CHR(10);
  ...
  **/
  ...
  BEGIN
        ...
        LOOP
          ...
          IF (Pn_ValorTotal(Ln_TotalOficinaImpIdx).TOTAL>0)THEN
            ...
            IF Lc_Plantilla(Ln_PlantillaIndice).TABLA_CABECERA='MIGRA_ARCGAE' THEN
              ...
              --*jilces::cambio por nueva compañia ecuanet, se usa la misma secuencia de megadatos
                  ...
                  ELSE
                    ...
                    LOOP
                      ...
                      IF Cr_OficinasFacturado(Pn_OficinaIdx).PRODUCTOS(Ln_ProductoIdx).IMPUESTO_ID = 
                        ...
                        Lr_MigraArcgal.MONTO      :=  Pn_Monto;
                        Lr_MigraArcgal.MONTO_DOL  :=  Pn_Monto;
                        -- Para MD en PORTADOR y SERVICIO solo estan configurados los Productos Instalacion, Soporte, Traslado y Reubicación
      ...
      END IF; 
       ...
       --replica de contabilizaion de compañia EN a MD
       if nvl(Lv_BanderaReplicar,'N') = 'S' AND Pv_CodEmpresa = Lv_EmpresaOrigen then
  ...
  BEGIN
    ...
    */
    ...
    -- se recupera parametro numero decimales a usa en contabilziación.
    IF C_PARAMETRO_CONTABILIZACION%ISOPEN THEN
      CLOSE C_PARAMETRO_CONTABILIZACION;
    END IF;
    --
