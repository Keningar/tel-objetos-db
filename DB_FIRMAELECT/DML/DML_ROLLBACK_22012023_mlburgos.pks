...
BEGIN
DBMS_LOB.APPEND(bada,'<!DOCTYPE html><html><head><title>Contrato Digital - Netlife</title>
...
DBMS_LOB.APPEND(bada, '<!-- ============================== -->
         ...
         style="margin-block-end: 1em !important;">
             <div id="row">
                 <div id="col" class="col-width-20"><b>Nombre Completos:</b></div>
...
DBMS_LOB.APPEND(bada, '<!-- ======================================== -->
     ...
     <div id="contenedor" class="col-width-100" >
             <div id="row">
                 ...
                 <div id="col" class="col-width-5"></div>
                 <div id="col" class="col-width-10" style="max-height: 1em;"> <b>Parroquia: </b> </div>
                 <div id="col" class="col-width-17 labelGris">
                     <span class="textPadding">$parroquia</span>
                 </div>
                 <div id="col" class="col-width-5" style="width: 4.7% !important;"></div>
                 <div id="col" class="col-width-13" style="max-height: 1em;"><b>Sector/Barrio:</b> </div>
              ...
              <tbody>
                <tr>
                     <td class="col-width-60" colspan="2">
                       ...
                       <div id="row">
                            <div id="colCell" class="col-width-10 textRight">COMPARTICIÓN:</div> 
                            <div id="colCell" class="col-width-30 textRight">
                                 <div id="col"class="col-width-50 line-height textCenter" colspan="2" style="height: 40px;">   
                                    <div>
                                        <div class="box">$!is2a1</div>
                                        <div class="box-label" style="$!fontSize">2:1</span>
                                    </div>
                                    <div>
                                        <div class="box">$!is1a1</div>
                                        <div class="box-label" style="$!fontSize">1:1</span>
                                    </div>
                                </div>
...
SET PLANTILLA_ID=(select ID_EMPRESA_PLANTILLA from 
DB_FIRMAELECT.ADM_EMPRESA_PLANTILLA WHERE COD_PLANTILLA='debitoMegadatos') where codigo='FIRMA_CONT_MD_AUT_DEBITO';
