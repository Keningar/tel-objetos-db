...
');
        ...
        <div style="width:60%; float:right; vertical-align:top;$!fontSize">
            ...
            <tbody>
                ...
                <tr>
');
        DBMS_LOB.APPEND(bada, '                     <td colspan="2">
        ...
        digitales.</div><br/>
           <span>
                ...
                <br/>
');
        DBMS_LOB.APPEND(bada, '                 <strong>QUINTA.-</strong> PRECIO, FORMA DE PAGO Y FACTURACIÓN: <strong>5.1.-</strong> El precio de los servicios contratados pueden ser
 ...
 ');
        DBMS_LOB.APPEND(bada, '                domicilio debido a causas no imputables a NETLIFE. <strong>9.13.- ALCANCE DE LA RESPONSABILIDAD DE NETLIFE.</strong>
...
');
  ...
  ');
        DBMS_LOB.APPEND(bada, '                   <div id="contenedor" style="float:right">
                        <div id="row">
...
');
 ...
 ');
        DBMS_LOB.APPEND(bada, '        <div id="contenedor" class="col-width-100" >
            <div id="row">
                <div id="col" class="col-width-10">
                    Número:
                </div>
