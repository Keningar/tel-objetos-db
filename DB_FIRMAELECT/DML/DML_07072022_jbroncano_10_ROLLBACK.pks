 ...
 * ROLLBACK de plantilla Requerimientos de Servicios
...
<html>
    ...
    <div id="contenedor" class="col-width-100" style="$!fontSize">
        ...
        <tr>     
            <td class="col-width-80" style="$!fontSize"><b>ADENDUM SERVICIOS / PRODUCTOS ADICIONALES</b></td> 
    ...
    <div id="contenedor" class="col-width-100">
        <div  style="$!fontSize" id="row">
            <div id="col" class="col-width-30">Fecha:</div>
            <div id="col" class="col-width-65 labelGris">$!fechaActual<span class="textPadding"></span></div>
        </div>
    </div>
