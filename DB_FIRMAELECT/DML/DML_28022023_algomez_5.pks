 ...
 * Inserción de plantilla ADENDUM para Ecuanet
...
DBMS_LOB.APPEND(bada, '<html>
    <head>
        <title>Requerimientos de Servicios - Ecuanet</title>
    ...
    <div id="contenedor" class="col-width-100" style="$!fontSize">
        ...
        <tr>     
            ...
            <td id="ecuanet" class="col-width-30" align="center" rowspan="2">
    ...
    <div id="contenedor" class="col-width-100">
        ...
        <div id="contenedor" class="col-width-100" style="$!fontSize">
            ...
            <div id="row">
                <div id="col" class="col-width-100">Forma de pago: El cliente acepta que la forma de pago de los servicios adicionales que contrate tendrán la misma forma de pago que el servicio principal de ECUANET contratado.</div>
            </div>
        </div>
...
SET HTML=EMPTY_CLOB()
where COD_PLANTILLA = 'adendumEcuanet'
AND EMPRESA_ID = 
(
SELECT
	ae.ID_EMPRESA
