 ...
 * ROLLBACK Actualización de plantilla CONTRATO para Ecuanet
...
<html>
 <head>
     <title>Contrato Digital - Ecuanet</title>
...
DBMS_LOB.APPEND(bada, '<body style="$!fontSize" onload="substitutePdfVariables()">
    <!-- ================================= -->
     <!-- Logo Ecuanet y numero de contrato -->
     <!-- ================================= -->
   <br/><br/><br/> 
     ...
     <table class="col-width-100">         
       <tr>     
           <td class="col-width-75" style="$!fontSize"><strong>CONTRATO DE ADHESIÓN PARA LA PRESTACIÓN DEL SERVICIO</strong></td> 
             <td id="ecuanet" class="col-width-25" text-align="right" rowspan="4">
               <div class="col-width-100" style="margin-left: 3.88rem; margin-top:-0.50rem;">
               <img src="http://images.telconet.net/others/telcos/logo_ecuanet.png" alt="log" title="ECUANET" height="60"/>
               <div style="font-size:14px">Telf 7201200</div>
...
DBMS_LOB.APPEND(bada, '<!-- ========================================================= -->
     ...
     <div style="text-align: justify; $!fontSize">
         <span>
                ...
                parte ECUANET (MEGADATOS S.A.), compañía constituida bajo las leyes de la República del Ecuador, cuyo objeto
                ...
                Comercial es ECUANET, en adelante denominado simplemente ECUANET, ubicada en la calle Blasco Núñez de Vela
                E3-13 y Atahualpa- Edificio Torre del Puente, en la provincia de Pichincha, cantón Distrito Metropolitano de Quito,
                ciudad de Quito, Parroquia Iñaquito, Teléfono: 02-7201200 , RUC: 1791287541001, mail: info@ecuanet.ec, web:
                www.ecuanet.ec 2) por otra parte el ABONADO, consciente expresamente en proporcionar sus datos personales a
                favor de ECUANET para la prestación de este servicio que se detallan a continuación:
...
DBMS_LOB.APPEND(bada, '<!-- ======================================== -->
 ...
 <div id="contenedor" class="col-width-100" >
     ...
     <div style="$!fontSize">
         <span>
             <strong>SEGUNDA.-</strong> OBJETO: ECUANET se compromete a proporcionar al ABONADO el acceso a redes nacionales e
              internacionales de Internet. Se deja expresa constancia que, ECUANET se responsabiliza única y exclusivamente
     ...
     <div id="contenedor" class="col-width-100" >
         <div id="row">
             ...
             <div id="col" class="col-width-40">
                 ...
                 <div class="box-label">'||chr(38)||'nbsp;'||chr(38)||'nbsp;'||chr(38)||'nbsp;'||chr(38)||'nbsp;'||chr(38)||'nbsp;'||chr(38)||'nbsp;'||chr(38)||'nbsp;'||chr(38)||'nbsp;</div>
...
DBMS_LOB.APPEND(bada, '<!-- ========================================== -->
    ...
    <spam>El tiempo de instalación promedio del servicio será hasta 5 días hábiles</spam></div>
    <div id="contenedor" class="col-width-100" style="height: 65px;">
        <div id="row">
...
DBMS_LOB.APPEND(bada, '
    ...
    digitales.</div><br/>
       <span>
            ...
            a ECUANET con por lo menos quince (15) días término de anticipación, para cuyo efecto procederá a cancelar los
            ...
            ECUANET. En caso de mora, ECUANET aplicará la máxima tasa de interés permitida por la ley por el periodo en
            ...
            <strong>5.3.-</strong> FACTURACIÓN: ECUANET mensualmente facturará y cobrará al ABONADO el servicio contratado de acuerdo
            ...
            de finalización del ciclo de facturación correspondiente. <strong>5.5.-</strong> ECUANET enviará a sus ABONADOS las facturas de
            conformidad con la ley, sin embargo, la no recepción de dicho documento no exime al ABONADO del pago
            correspondiente. <strong>5.6.-</strong> El ABONADO cancelará por periodos mensuales a ECUANET por la prestación del servicio
            contratado a los precios pactados a través de éste instrumento y sus anexos o adendums, hasta el fin del período;
            si el ABONADO no cancelare los valores facturados dentro del plazo previsto, ECUANET suspenderá los servicios
            ...
            pospago para lo cual el abonado acepta que ECUANET facturará y cobrará de manera anticipada y mensual el
            ...
            adicional que eventualmente instalen nuestros técnicos son propiedad de ECUANET. Ningún equipo terminal forma
            parte íntegra del servicio contratado, ECUANET instalará el equipo más conveniente según factibilidad y
            ...
            del servicio pueden ser: CPE, que es el equipo que ECUANET lo instala en las premisas del suscriptor e incluye WiFi
            ...
            específico, informado, e inequívoco, a fin de que ECUANET realice el tratamiento de los datos personales que le
            proporcione por cualquier medio.<strong>7.2.-</strong> ECUANET actuará como responsable del tratamiento de los datos personales
            ...
            ECUANET tuviere acceso, perdurará mientras se mantenga vigente el contrato hasta después de la terminación de
            ...
            entre otros medios de recolección, serán utilizados por ECUANET para gestionar adecuadamente los productos y
            servicios, y en los términos informados en la política de privacidad y sus actualizaciones que pueden ser
            consultadas en el siguiente link: https://www.ecuanet.ec/politica-privacidad/. <strong>7.5.-</strong> El ABONADO proporcionará los
            ...
            de los derechos al correo electrónico delegadodatos@ecuanet.ec, a la dirección: Atahualpa E313 y Núñez de
            Vela, Edificio Torre del Puente, piso 3, o al teléfono 02-7201200 correspondientes a ECUANET y su Delegado de
            ...
            recolectados por ECUANET son obligatorios. Consecuentemente la negativa a suministrarlos supondrá la
            imposibilidad de concretar el servicio a ser contratado. Asimismo, en caso de proporcionar datos erróneos o
            inexactos, ECUANET se reserva el derecho a dar por terminado unilateralmente el presente contrato. <strong>7.9.-</strong>ECUANET
            ...
            Telecomunicaciones. En caso de transferencia internacional, ECUANET se cerciorará que sea efectuada a
            ...
            https://www.ecuanet.ec/destinatarios-datos/ <br/>
            Comprometidos con la protección y seguridad de sus datos personales, solicitamos revisar tus opciones de
            privacidad y ajustarlas según tus 
            <div id="row">
            <div id="colCell" class="col-width-45"> preferencias. <strong>7.10.-</strong> Acepto la Política de tratamiento de Datos Personales</div>
            <div id="colCell" class="col-width-44"><a href="https://www.ecuanet.ec/politica-tratamiento-datos-personales/">(https://www.ecuanet.ec/politica-tratamiento-datos-personales/ )</a></div>
            </div> 
            , cuyo tratamiento ulterior permitirá estar informado de novedades, mejoras y ofertas personalizadas de ECUANET.<br/>
...
DBMS_LOB.APPEND(bada, '<strong>OCTAVA.-</strong> 
            ...
            oficiales de ECUANET, consulte la página web www.ecuanet.ec <strong>8.1.-</strong> En caso de reclamos o quejas, el tiempo máximo
            de respuesta es de 7 días siempre que el cliente la haya registrado y reportado a través de un ticket (tarea) por
            medio de los canales de atención de ECUANET. Si refiere a reclamos por velocidad, el cliente deberá generar 2 ó 3
            pruebas de velocidad manteniendo conectado un solo dispositivo, siempre con cable de red (conexión directa, no
            inalámbrica), utilizando el velocímetro provisto por ECUANET (https://www.ecuanet.ec/atencion-al-cliente/velocimetro-ecuanet/), guardar
            ...
            <strong>NOVENA.- </strong>OBLIGACIONES Y CONDICIONES DE ECUANET: <strong>9.1.- </strong>El tiempo de instalación promedio del servicio
            ...
            no autorizados previamente). ECUANET no se hace responsable por pérdidas o daños que puedan derivarse de la
            ...
            expresamente que ECUANET proceda el cobro del valor de $1.00 + impuestos de ley por concepto de los reprocesos
            ...
            coloquen los equipos de propiedad de ECUANET. El cliente es responsable de mantener las conexiones eléctricas
            internas en correcto estado, donde ECUANET instale sus equipos, por ello deslinda de responsabilidad a ECUANET
            ...
            nuestro sitio web: https://www.ecuanet.ec/guia-de-seguridad-y-control-de-internet/ <strong>9.10.- </strong>Para tener conocimiento de
            los derechos que lo asisten como usuario, puede encontrar la norma de Calidad, así como el link directo a la página
            de ARCOTEL en nuestro sitio web. <strong>9.11.- </strong>El cliente garantizará que el personal designado por ECUANET pueda
            ...
            ECUANET, generar evidencias cuando lo requiera o ponga en riesgo la seguridad de la red. El incumplimiento o
            ...
            domicilio debido a causas no imputables a ECUANET. <strong>9.13.- ALCANCE DE LA RESPONSABILIDAD DE ECUANET.</strong>
            - ECUANET no se hará responsable en los siguientes casos: <strong>9.14.- </strong>En caso de orden judicial, caso fortuito o fuerza
            mayor debidamente comprobadas se vea en la obligación de suspender el servicio. No obstante, de lo anterior,
            ECUANET se compromete a informar inmediatamente de este hecho al ABONADO. <strong>9.15.- </strong>En caso de que se
            ...
            comercialización, subarrendamiento, reventa del servicio sin autorización de ECUANET, por mandato judicial y por
            las demás causas previstas en el ordenamiento jurídico vigente, lo cual provocará que ECUANET proceda con la
            suspensión del servicio. <strong>9.17.- </strong>ECUANET no podrá bloquear, priorizar, restringir o discriminar de modo arbitrario y
            ...
            ECUANET. Del mismo modo podrá ofrecer, si el ABONADO lo solicita, servicio de control y bloqueo de contenidos
            ...
            <br/><br/><strong>DÉCIMA.- </strong>OBLIGACIONES Y DERECHOS DEL ABONADO: <strong>10.1.- </strong>Cancelar a ECUANET todos los valores
            ...
            ECUANET información fidedigna de sus datos personales necesarios para la prestación del servicio. <strong>10.5.- </strong>La
            instalación del servicio de internet incluye un punto de acometida donde se colocarán el (los) equipo (s), de
            propiedad y administrados exclusivamente por personal de ECUANET. Cualquier manipulación o alteración de la
            ...
            ajenas a ECUANET, realizará la configuración interna de su red de área local, del control de la información y
            navegación que realice por Internet. ECUANET pone a disposición de los clientes un servicio integral de seguridad
            ...
            ECUANET coordinará previamente con el cliente a fin de generar el menor impacto posible. <strong>10.8.- </strong>No se podrán
            aplicar rebajas o descuentos sobre otras promociones ya otorgadas previamente. <strong>10.9.- </strong>El cliente acepta que
            ECUANET en planes de Internet, para evitar el SPAM, mantenga restringido el puerto 25 (debidamente autorizado
            ...
            disponibilidad del 98%. El tiempo promedio de reparación mensual de todos los clientes de ECUANET es de 24
            horas, siempre que el cliente haya notificado y registrado su requerimiento con un ticket (tarea) interno a través de
            los canales de atención al cliente de ECUANET disponibles y mencionados en nuestra página web; se excluye el
            ...
            acepta que ha sido explicado sobre todo el contenido de este instrumento compartido por parte de ECUANET, por
            ...
            de atención al cliente de la página web www.ecuanet.ec, o por medio de nuestros canales digitales oficiales
            habilitados, sin eximir del pago de todos los valores que se adeuden a la fecha de la terminación. El abonado
            deberá entregar los equipos que son propiedad de ECUANET al momento de cancelar el servicio en un plazo máximo
            ...
            Aplicación de las normas legales, el caso fortuito o fuerza mayor que obliguen a ECUANET a suspender
            ...
            ISP clandestino, reventa del servicio proporcionado por ECUANET o cuando se realice un uso diferente conforme a
            las características del plan contratado, bastando para la terminación un reporte generado por ECUANET que
            ...
            <br/><br/><strong>DÉCIMO CUARTA.- </strong>NOTIFICACIONES: Toda notificación que requiera realizarse en relación con el presente Contrato, se hará por escrito a las siguientes direcciones: <strong>14.1.- </strong>ECUANET: Quito: Av. Núñez de Vela E3-13 y
            Atahualpa, Edificio torre del Puente Piso 3, Guayaquil: Av. Rodrigo de Chávez, Parque Empresarial Colón
            Ed.Coloncorp,Torre 6, Locales 4 y 5, o en la dirección de correo electrónico info@ecuanet.ec <strong>14.2.- </strong>ABONADO en
...
DBMS_LOB.APPEND(bada, '<!-- ========================================== -->
    ...
    <div style="text-align: justify;">
        <span>El titular suscriptor del contrato declara haber leído este contrato y la solicitud de prestación de servicios en su totalidad, por ello se encuentra conforme con todas y cada una de sus cláusulas. El
        cliente declara que la información suministrada a ECUANET es veraz y correcta so pena de judicalización. Adicionalmente autoriza a ECUANET a verificarla en cualquier momento. El cliente autoriza a 
        ECUANET expresamente a entregar y requerir información, en forma directa, a los burós de información crediticia o entidades designadas para estas calificaciones sobre su comportamiento y capacidad de pago,
...
DBMS_LOB.APPEND(bada, '<!-- ================================================================= -->
    ...
    <div id="contenedor" class="col-width-100" style="padding-block-end: 10em;">
      ...
      <div id="contenedor" class="col-width-100" >
        <div id="row">
            <div id="col" class="col-width-40">
                Autorizo a MEGADATOS S.A. a debitar de mi cuenta:
            </div>
    ...
    <div style="text-align: justify;">
        <span>
          El valor de los servicios y el pago respectivo a MEGADATOS S.A. por concepto de todos los valores estipulados en el contrato firmado entre las partes. Me comprometo a mantener fondos suficientes y 
          disponibles para cubrir dicho pago. Al acreditar al beneficiario agradeceré mencionar como referencia lo siguiente: PAGO EFECTUADO A ECUANET POR SERVICIOS.
         </span>
    </div>
    <br/>
    <br/>
...
SET HTML=EMPTY_CLOB()
where COD_PLANTILLA = 'contratoEcuanet'
AND EMPRESA_ID = 
(
SELECT
	ae.ID_EMPRESA
