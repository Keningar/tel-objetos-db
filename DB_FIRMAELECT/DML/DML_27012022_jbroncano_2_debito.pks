	...
	<body style="$!fontSize">
        ...
        <div align="center" style="float: right;">
            <table id="netlife" style="padding-right: 30px; ">
                ...
                <tr></tr>
                <tr><td align="center" style="font-size:17px">$numeroContrato</td></tr>
            </table>
        </div>
        ...
        <div  style="float:right; min-width: 120px; text-align:center;">
            <div id="row" >
                <div id="col" class="col-width-30" style="text-align:center; $!fontSize ">
                    $!versionTitulo
                </div>   
            </div>  
            <div id="row" >
                <div id="col" class="col-width-50" style="text-align:center; $!fontSize">
                    $!versionFecha
                </div>
            </div>
        </div>
