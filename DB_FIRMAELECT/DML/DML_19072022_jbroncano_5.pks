 ...
 * actualizacion de plantilla Términos y Condiciones
                    ...
                    <div id="contenedor" class="col-width-100">
                        ...
                        <div id="row">
                            ...
                            <div id="colCell" class="col-width-50">
                                <input id="inputfirma1" name="FIRMA_TERMINOS_MD_EMPRESA" type="text" value="hahahah" style="background-color:#fff; width:0.0em; margin-left:0.75em; border-style: hidden; opacity:0; border:none;" readonly/>
                            </div>
                            <div id="colCell" class="col-width-10"></div>
                        </div>
                        <div id="row">
                    ...
                    <div id="contenedor" class="col-width-100">
                        ...
                        <div id="row">
                            ...
                            <div id="colCell" class="col-width-50">
                                ...
                                <input id="inputfirma2" name="FIRMA_TERMINOS_MD_CLIENTE" type="text" value="jssjsjsjsjs" style="background-color:#fff; width:0.0em; margin-left:0.75em; border-style: hidden; opacity:0; border:none;" readonly/>
                            </div>
                            <div id="colCell" class="col-width-10"></div>
                        </div>
                        <div id="row">
