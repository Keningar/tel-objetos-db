 ...
 /* // ==========================================               // Viñetas para las clausulas
   ...
   <body style="$!fontSize">
        ...
        <div align="center" style="float: right;">
            <table id="netlife" style="padding-right: 5px; ">
                <tr>
                ...
                <tr></tr>
                <tr><td  style="font-size:18px">$numeroContrato</td></tr>
            </table>
        </div>
		<!-- ========================================== -->
		<!-- Pagare									    -->
        ...
        <div id="row">
                  ...
                  style="height: 12px !important;line-height: 12px;">
                 ...
                 <div id="col" class="col-width-40"
                 style="height: 5px !important;line-height: 5px;">
		...
		<div id="contenedor" class="col-width-100">
            ...
            <div id="row"  style="$!fontSize">
                <div id="colCell" class="col-width-12">
            ...
            <div id="row">
                ...
                <div id="colCell" class="col-width-50">
                    <div id="contenedor" class="col-width-100" style="$!fontSize">
                        <div id="row" >
                            <div id="colCell" class="col-width-25"><span>Firma:</span>
                                <form >
                                    <input id="inputfirma1" name="FIRMA_CONT_MD_PAGARE" type="text" value="" style="background-color:#fff; width:0.0em; margin-left:0.75em; border-style: hidden; opacity:0; border:none;"/>
                            </form>
                            </div>
                            <div id="col" class="col-width-50">
                              </br>
                        ...
                        <div id="row" style="$!fontSize" >
                            ...
                            <div id="col" class="col-width-70 labelGris">
                                    <span class="textPadding"><span class="textPadding"> </span> $nombresApellidos</span>
                            </div>
                            <div id="col" class="col-width-25"></div>
                        </div>
                    </div>
        ...
        <div  style="float:right; min-width: 200px; text-align:center;">
            <div id="row" >
