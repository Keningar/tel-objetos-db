CREATE EDITIONABLE TRIGGER DB_INFRAESTRUCTURA.TRG_PROCESO_MASIVO_CAB
...
ALTER TRIGGER "DB_INFRAESTRUCTURA"."TRG_PROCESO_MASIVO_CAB" DISABLE;

ALTER TRIGGER "DB_INFRAESTRUCTURA"."TRG_PROCESO_MASIVO_CAB" 
  COMPILE 
