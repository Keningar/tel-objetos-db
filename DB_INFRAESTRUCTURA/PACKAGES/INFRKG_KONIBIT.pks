CREATE EDITIONABLE PACKAGE                    INFRKG_KONIBIT AS 
...
CREATE EDITIONABLE PACKAGE BODY                    INFRKG_KONIBIT
AS
  ...
  BEGIN 
    ...
    ELSE
      ...
      IF Lv_estado = 'ERROR' THEN
        Pv_error := APEX_JSON.GET_VARCHAR2('mensaje');
      END IF;
    END IF;
