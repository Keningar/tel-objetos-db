        ...
        LOOP
          ...
          IF LV_ERROR       IS NOT NULL THEN
            LV_STATUSRESULT := 'ERROR';
              DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('Telcos+', 'INKG_REPROCESO_ANALITICA.P_REPROCESO_CAMARAS_ANALITICA', 'Ocurri� un error al reprocesar el servicio ' || LN_SERVICIOID || ' -' || LV_ERROR, LV_USUARIO, SYSDATE, LV_IPORIGEN);
          END IF;
