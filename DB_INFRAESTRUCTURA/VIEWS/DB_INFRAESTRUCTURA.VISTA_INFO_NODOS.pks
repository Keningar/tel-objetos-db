/* Formatted on 5/2/2023 10:03:42 AM (QP5 v5.336) */
CREATE OR REPLACE FORCE VIEW DB_INFRAESTRUCTURA.VISTA_INFO_NODOS
(
    ID_ELEMENTO,
    NOMBRE_ELEMENTO,
...
AS
    SELECT elemento.ID_ELEMENTO,
           ...
           NVL (GET_DETALLE_ELEMENTO_NOMBRE ('CLASE', elemento.ID_ELEMENTO),
                'N/A')                                AS CLASE,
           NVL (GET_DETALLE_ELEMENTO_NOMBRE ('TORRE', elemento.ID_ELEMENTO),
                'N/A')                                AS TORRE,
           NVL (
               GET_DETALLE_ELEMENTO_NOMBRE ('COBERTURA',
                                            elemento.ID_ELEMENTO),
               'N/A')                                 AS COBERTURA,
           NVL (
               GET_DETALLE_ELEMENTO_NOMBRE ('TIPO MEDIO',
                                            elemento.ID_ELEMENTO),
               'N/A')                                 AS TIPO_MEDIO,
           ...
           (SELECT COUNT (*)
             ...
             WHERE     DETALLE_SOLICITUD_ID = solicitud.id_detalle_solicitud
                   AND ESTADO = 'Finalizada')         CANT_FINALIZADAS,
      ...
      FROM info_elemento                elemento,
           ...
           admi_motivo                  motivo
     WHERE     elemento.MODELO_ELEMENTO_ID =
               modelo_elemento.ID_MODELO_ELEMENTO
           AND modelo_elemento.TIPO_ELEMENTO_ID =
           ...
           AND solicitud.id_detalle_solicitud =
               sol_caract.DETALLE_SOLICITUD_ID
