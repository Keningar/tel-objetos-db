CREATE FORCE EDITIONABLE VIEW "DB_INFRAESTRUCTURA"."VISTA_MONITOREO_UPS" ("ID", "ID_UPS", "NOMBRE_UPS", "NOMBRE_NODO", "IP_UPS", "TIPO", "GENERADOR", "DIRECCION", "LATITUD", "LONGITUD", "REGION", "PROVINCIA", "CIUDAD", "SEVERIDAD", "DESCRIPCION_ALERTA", "VALOR", "FECHA_MODIFICACION", "ESTADO_ALERTA") AS 
