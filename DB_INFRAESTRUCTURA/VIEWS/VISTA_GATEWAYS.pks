CREATE OR REPLACE VIEW "DB_INFRAESTRUCTURA"."VISTA_GATEWAYS" ("NOMBRE_MARCA_ELEMENTO", "NOMBRE_MODELO_ELEMENTO", "ID_ELEMENTO", "NOMBRE_ELEMENTO", "IP", "NOMBRE_USUARIO_ACCESO", "CONTRASENA", "ESTADO", "EMPRESA_COD") AS 
  SELECT
