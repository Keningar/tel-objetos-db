CREATE OR REPLACE VIEW "DB_INFRAESTRUCTURA"."V_PUERTO_CLIENTES" ("NOMBRE_ELEMENTO", "NOMBRE_INTERFACE_ELEMENTO", "LOGIN", "LOGIN_AUX", "ID_SERVICIO", "RAZON_SOCIAL", "PRODUCTO", "SERVICIO", "ESTADO_SERVICIO", "FECHA_CANCELACION", "USR_VENDEDOR", "BW_SUBIDA", "BW_BAJADA", "TIPO_PROTOCOLO", "IP", "ESTADO_IP") AS 
  SELECT
