CREATE OR REPLACE package NAF47_TNET.INK_PROCESA_PEDIDOS is
...
CREATE OR REPLACE package body NAF47_TNET.INK_PROCESA_PEDIDOS is
  ...
  */
  PROCEDURE P_PROCESA_DETALLE_SERIE ( Ln_PedidoDetalle  IN NUMBER,
    ...
    --
  BEGIN
    INSERT INTO DB_COMPRAS.INFO_PEDIDO_DETALLE_SERIE
         ( ID_PEDIDO_DETALLE_SERIE,PEDIDO_DETALLE_ID,  SERIE,
           MAC,PRODUCTO_ID,DESCRIPCION_PRODUCTO,ESTADO,
           FE_CREACION, USR_CREACION)
   VALUES( DB_COMPRAS.SEQ_INFO_PEDIDO_DETALLE_SERIE.NEXTVAL,Ln_PedidoDetalle, Lv_PedidoSerie,
           Lv_PedidoMac, Lv_ProductoId, Lv_Descripcion, Lv_PedidoEstado,
           SYSDATE,      USER);
    ...
    if Pv_Estado = 'Inicio' AND
      ...
      INSERT INTO NAF47_TNET.LOG_PEDIDOS
        (ID_LOG_PEDIDOS,
         ...
         TIEMPO_DESPACHO)
      VALUES
        (NAF47_TNET.SEQ_LOG_PEDIDOS.NEXTVAL,
         Pn_IdPedido,
