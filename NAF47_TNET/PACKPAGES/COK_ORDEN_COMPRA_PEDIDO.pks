CREATE OR REPLACE package            COK_ORDEN_COMPRA_PEDIDO is
  /**
...
CREATE OR REPLACE package body            COK_ORDEN_COMPRA_PEDIDO is
  /**
  ...
  */
    ...
    CURSOR C_DATOS_EMPLEADO IS
      ...
      SELECT EN.NO_EMPLE AS EMPLEADO_ASIGNADO_ID,
        ...
        JOIN DB_COMPRAS.ADMI_DEPARTAMENTO DC
          ON DC.EMPRESA_ID = EC.ID_EMPRESA
         AND DC.DPTO_COD = EN.DEPTO
       WHERE EN.LOGIN_EMPLE = GEK_CONSULTA.F_RECUPERA_LOGIN
         AND Pv_NoTransf IS NOT NULL;
    --
  ...
  BEGIN
    ...
    FOR Lr_OrdenCompra IN C_ORDEN_COMPRA LOOP
      ...
      ELSE
        --
        Lr_OrdenCompra.Id_Pedido_Detalle := DB_COMPRAS.SEQ_INFO_PEDIDO_DETALLE.NEXTVAL;
        --
    ...
    IF SQL%ROWCOUNT > 0 THEN
      ...
      INSERT INTO DB_COMPRAS.INFO_PEDIDO_ESTADO
        (ID_PEDIDO_ESTADO,
         ...
         IP_CREACION)
      VALUES
        (DB_COMPRAS.SEQ_INFO_PEDIDO_ESTADO.NEXTVAL,
         Ln_PedidoId,
         CON_ORDEN_COMPRA,
         GEK_CONSULTA.F_RECUPERA_LOGIN,
         SYSDATE,
    ...
    FOR Lr_DetOrden IN C_DETALLE_ORDEN LOOP
      ...
      --
      NAF47_TNET.PRKG_CONTROL_PRESUPUESTO.P_INSERTA_DOC_DISTRIBUCION2(Lr_DocDistribucion,
                                                                     Pv_MensajeError);
      --
      IF Pv_MensajeError IS NOT NULL THEN
        RAISE Le_Error;
  ...
  CURSOR C_IMPUESTO (Cn_IdEmpresa DB_COMPRAS.ADMI_EMPRESA.ID_EMPRESA%TYPE) IS
  SELECT TO_NUMBER(VALOR, '999.999') VALOR FROM DB_COMPRAS.ADMI_PARAMETRO 
      WHERE EMPRESA_ID=Cn_IdEmpresa
      AND CODIGO='IVA-12';
  ...
  BEGIN
    ...
    OPEN C_IMPUESTO(Lr_InfoSolicitud.Empresa_Id);
  ...
  BEGIN
    ...
    ELSE
      IF Lt_ArinCatArtKatuk.nivel = '1' THEN
        ...
        Lt_ArinCatArtKatuk.id_catalogo := NAF47_TNET.SEQ_ARIN_CATALOGO_KATUK_CAB.NEXTVAL;
      ...
      ELSIF Lt_ArinCatArtKatuk.nivel = '2' THEN
        ...
        IF Lt_ArinCatArtKatukDet.Catalogo_Id IS NOT NULL THEN
          Lt_ArinCatArtKatukDet.Id_Catalogo_Det := NAF47_TNET.SEQ_ARIN_CATALOGO_KATUK_DET.NEXTVAL;
