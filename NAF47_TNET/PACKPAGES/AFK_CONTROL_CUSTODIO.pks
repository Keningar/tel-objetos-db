CREATE EDITIONABLE package            AFK_CONTROL_CUSTODIO is
  /**
...
CREATE EDITIONABLE package body            AFK_CONTROL_CUSTODIO is
  ...
  */
  ...
  BEGIN
    ...
    IF Ln_IdPersona IS NULL THEN
      ...
      INSERT INTO DB_COMERCIAL.INFO_PERSONA
        ...
        SELECT Ln_IdPersona,
               ...
               'Activo' AS ESTADO,
               SYSDATE,
               NVL(GEK_CONSULTA.F_RECUPERA_LOGIN,USER),
    ...
    END IF;
    --
    Pn_PersEmpRol := DB_COMERCIAL.SEQ_INFO_PERSONA_EMPRESA_ROL.NEXTVAL;
    --
  ...
  */
  ...
  BEGIN
    ...
    FOR Li_Idx IN Pt_Transferencia.FIRST .. Pt_Transferencia.LAST LOOP
      ...
      IF Lr_ControlCustodio.Observacion != 'Migracion Saldo Inicial' 
        ...
        --
        Lr_ControlCustodio.Id_Control := SEQ_ARAF_CONTROL_CUSTODIO.NEXTVAL;
        --
  ...
  BEGIN
    ...
    FOR Lr_Reg IN C_ARTICULO_CONTROL_CUSTODIO LOOP
      ...
      Lr_ControlCustodio.Valor_Base           := 0;
      Lr_ControlCustodio.Usr_Creacion         := GEK_CONSULTA.F_RECUPERA_LOGIN;
      Lr_ControlCustodio.Estado               := AFK_CONTROL_CUSTODIO.Gc_EstadoAsignado;
  ...
  BEGIN
    ...
    FOR Li_Idx IN Pt_DatosIB.FIRST..Pt_DatosIB.LAST LOOP
      ...
      IF Pt_DatosIB(Li_Idx).GENERA_SERIE = 'S' AND Lr_SerieSegmentada.Serie_Anterior IS NULL THEN
        ...
        Pt_Transferencia(1).LOGIN_EMPLEADO := GEK_CONSULTA.F_RECUPERA_LOGIN;
        --
  ...
  BEGIN
    ...
    ELSE
      ...
      Lr_InfoElementoTrazabilidad.Usr_Creacion    := NAF47_TNET.GEK_CONSULTA.F_RECUPERA_LOGIN;
  ...
  BEGIN
    ...
    Lr_InfoRelacionElemento.USR_CREACION   := NAF47_TNET.GEK_CONSULTA.F_RECUPERA_LOGIN;
    Lr_InfoRelacionElemento.IP_CREACION    := NAF47_TNET.GEK_CONSULTA.F_RECUPERA_IP;
    Lr_InfoRelacionElemento.ESTADO         := Pv_Estado;
    --
    DB_INFRAESTRUCTURA.INFRK_DML.INFRP_INSERT_RELACION_ELEMENTO (Lr_InfoRelacionElemento,
                                                                 Pv_MensajeError);
