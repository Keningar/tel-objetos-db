CREATE OR REPLACE package            ARCPK_WEBSERVICE is
...
CREATE OR REPLACE package body            ARCPK_WEBSERVICE is
    ...
    For ret in C_retenciones loop
        ...
        IF Lv_OrigenDocumento = 'Offline' THEN
               ...
               FETCH C_UsuarioExiste INTO Ln_IdUsuario;
                ...
                Lr_CompInfoDocumento.XML_ORIGINAL               := DB_FINANCIERO.FNCK_COM_ELECTRONICO.F_XMLBLOG(ret.result_xml);
