CREATE OR REPLACE PACKAGE            "NAKG_GESTIONPERSONA_TRANSACC" AS 
...
CREATE OR REPLACE PACKAGE BODY            "NAKG_GESTIONPERSONA_TRANSACC" AS
  ...
  BEGIN
    ...
    INSERT
        ...
        NAF47_TNET.SEQ_INFO_DOCUMENTO.NEXTVAL@GPOETNET,
        (
          Lv_TipoDocumentoId
        ),
        (
