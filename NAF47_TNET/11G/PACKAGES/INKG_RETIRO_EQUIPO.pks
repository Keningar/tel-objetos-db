CREATE OR REPLACE package NAF47_TNET.INKG_RETIRO_EQUIPO is
 ...
 */
  ...
  *
  * @param Pr_FiltroElemento  IN VARCHAR2     Recibe parametro tipo registro con información filtro de busqueda de elementos
...
CREATE OR REPLACE package body NAF47_TNET.INKG_RETIRO_EQUIPO is
  --
  ASIGNADO CONSTANT VARCHAR2(08) := 'Asignado';
  --
  /**
  * Documentacion para P_PRE_REQUISITO_RETIRO
  * Procedimiento valida la información necesaria para procear retiro de equipos
  * @author llindao <llindao@telconet.ec>
  * @version 1.0 24/11/2020
  *
  * @author llindao <llindao@telconet.ec>
  ...
  */
      ...
      IF (Pr_DetalleElemento(Li_Elemento).SERIE_FISICA IS NULL OR 
        ...
        INSERT INTO DB_INFRAESTRUCTURA.INFO_HISTORIAL_ELEMENTO
          (ID_HISTORIAL,
           ...
           IP_CREACION)
        VALUES
          (DB_INFRAESTRUCTURA.MIG_SECUENCIA.SEQ_INFO_HISTORIAL_ELEMENTO,
      ...
      IF NVL(Pr_DetalleElemento(Li_Elemento).MAC, '@') <> Pr_DetalleElemento(Li_Elemento).W_MAC AND
        ...
        INSERT INTO DB_INFRAESTRUCTURA.INFO_DETALLE_ELEMENTO
          (ID_DETALLE_ELEMENTO,
           ...
           ESTADO)
        VALUES
          (DB_INFRAESTRUCTURA.MIG_SECUENCIA.SEQ_INFO_DETALLE_ELEMENTO,
           Pr_DetalleElemento(Li_Elemento).ID_ELEMENTO,
           'MAC',
           Pr_DetalleElemento(Li_Elemento).W_MAC,
           'MAC',
  ...
  EXCEPTION
    WHEN Le_Error THEN
      --
      DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('NAF',
                                           'INKG_RETIRO_EQUIPO.P_PRE_REQUISITO_RETIRO-Le_Error',
                                           Pv_MensajeError,
    ...
    WHEN OTHERS THEN
      ...
      --
      DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('NAF',
                                           'INKG_RETIRO_EQUIPO.P_PRE_REQUISITO_RETIRO-OTHERS',
                                           Pv_MensajeError,
                                           NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,
                                                            GEK_VAR.Gr_Sesion.HOST),
                                                user), SYSDATE,
  ...
  * Procedimiento que genera transaccion ingreso a bodega en módulo de inventarios.
  * @author llindao <llindao@telconet.ec>
  * @version 1.0 24/11/2020
  *
  * @param Pr_FiltroElemento  IN VARCHAR2     Recibe parametro tipo registro con información filtro de busqueda de elementos
  ...
  */  
  ...
  BEGIN
    ...
    FOR Li_Elemento IN 1 .. Pr_DetalleElemento.LAST LOOP
      ...
      IF NVL(Lv_Existe,'@') <> 'X' THEN
        ...
        Lr_Arinme.No_Fisico := NAF47_TNET.MIG_SECUENCIA.SEQ_FRM_IM;--Consecutivo.INV(Lr_Arinme.No_Cia, Lr_DatosPeriodo.Ano_Proce, Lr_DatosPeriodo.Mes_Proce, Lr_Arinme.Centro, Lr_Arinme.Tipo_Doc, 'NUMERO');
  ...
  EXCEPTION
    WHEN Le_Error THEN
      --
      DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('NAF',
                                           'INKG_RETIRO_EQUIPO.P_CREA_INGRESO_BODEGA-Le_Error',
                                           Pv_MensajeError,
                                           NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.HOST),user), 
                                           SYSDATE,
                                           NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.IP_ADRESS),'127.0.0.1'));
    ...
    WHEN OTHERS THEN
      ...
      --
      DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('NAF',
                                           'INKG_RETIRO_EQUIPO.P_CREA_INGRESO_BODEGA-OTHERS',
                                           Pv_MensajeError,
                                           NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.HOST),user), 
                                           SYSDATE,
                                           NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.IP_ADRESS),'127.0.0.1'));
  ...
  */  
  ...
  EXCEPTION
    WHEN Le_Error THEN
      --
      DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('NAF',
                                           'INKG_RETIRO_EQUIPO.P_FINALIZA_SOLICITUD-Le_Error',
                                           Pv_MensajeError,
                                           NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.HOST),user), 
                                           SYSDATE,
                                           NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.IP_ADRESS),'127.0.0.1'));
    ...
    WHEN OTHERS THEN
      ...
      --
      DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('NAF',
                                           'INKG_RETIRO_EQUIPO.P_FINALIZA_SOLICITUD-OTHERS',
                                           Pv_MensajeError,
                                           NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.HOST),user), 
                                           SYSDATE,
                                           NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.IP_ADRESS),'127.0.0.1'));
  ...
  PROCEDURE P_PROCESAR (Pr_FiltroElemento  IN OUT INKG_RETIRO_EQUIPO.Gr_FiltroElemento,
    ...
    Le_Error EXCEPTION;
    --
    Pr_FiltroElementoTmp   INKG_RETIRO_EQUIPO.Gr_FiltroElemento@GPOETNET;
    Pr_DetalleElementoTmp  INKG_RETIRO_EQUIPO.Gt_DetalleElemento@GPOETNET:=INKG_RETIRO_EQUIPO.Gt_DetalleElemento@GPOETNET();

  BEGIN
    --
    DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('NAF',
                                         'P_PROCESAR.P_PROCESAR-01',
                                         'ANTES DE Pr_FiltroElementoTmp:=Pr_FiltroElemento;',
                                         NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.HOST),user), 
                                         SYSDATE,
                                         NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.IP_ADRESS),'127.0.0.1'));          
    Pr_FiltroElementoTmp.ID_DETALLE_SOLICITUD := Pr_FiltroElemento.ID_DETALLE_SOLICITUD;
    Pr_FiltroElementoTmp.TXT_LOGIN_EMPLE := Pr_FiltroElemento.TXT_LOGIN_EMPLE;
    Pr_FiltroElementoTmp.TXT_TECNICO := Pr_FiltroElemento.TXT_TECNICO;
    Pr_FiltroElementoTmp.TXT_NOCIA := Pr_FiltroElemento.TXT_NOCIA;
    Pr_FiltroElementoTmp.TXT_CENTRO := Pr_FiltroElemento.TXT_CENTRO;
    Pr_FiltroElementoTmp.REF_ASIGNADO_ID := Pr_FiltroElemento.REF_ASIGNADO_ID;
    Pr_FiltroElementoTmp.LOGIN := Pr_FiltroElemento.LOGIN;
    Pr_FiltroElementoTmp.TOTAL_ELEMENTO := Pr_FiltroElemento.TOTAL_ELEMENTO;
    --
    DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('NAF',
                                         'P_PROCESAR.P_PROCESAR-02',
                                         'ANTES DEL FOR Pr_DetalleElemento',
                                         NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.HOST),user), 
                                         SYSDATE,
                                         NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.IP_ADRESS),'127.0.0.1'));          

    for i in Pr_DetalleElemento.first .. Pr_DetalleElemento.last loop
        --
        DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('NAF',
                                             'P_PROCESAR.P_PROCESAR-for-'||TO_CHAR(i),
                                             'ANTES DEL FOR Pr_DetalleElemento',
                                             NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.HOST),user), 
                                             SYSDATE,
                                             NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.IP_ADRESS),'127.0.0.1'));
        --
      Pr_DetalleElementoTmp.extend();
      Pr_DetalleElementoTmp(i).TXT_NO_DOCU := Pr_DetalleElemento(i).TXT_NO_DOCU;
      Pr_DetalleElementoTmp(i).TXT_ESTADO := Pr_DetalleElemento(i).TXT_ESTADO;
      Pr_DetalleElementoTmp(i).SERIE_FISICA := Pr_DetalleElemento(i).SERIE_FISICA;
      Pr_DetalleElementoTmp(i).W_SERIE_FISICA := Pr_DetalleElemento(i).W_SERIE_FISICA;
      Pr_DetalleElementoTmp(i).MAC := Pr_DetalleElemento(i).MAC;
      Pr_DetalleElementoTmp(i).W_MAC := Pr_DetalleElemento(i).W_MAC;
      Pr_DetalleElementoTmp(i).ID_ELEMENTO := Pr_DetalleElemento(i).ID_ELEMENTO;
      Pr_DetalleElementoTmp(i).NOMBRE_TIPO_ELEMENTO := Pr_DetalleElemento(i).NOMBRE_TIPO_ELEMENTO;
      Pr_DetalleElementoTmp(i).NOMBRE_MODELO_ELEMENTO := Pr_DetalleElemento(i).NOMBRE_MODELO_ELEMENTO;
      Pr_DetalleElementoTmp(i).CKB_IND_MAC := Pr_DetalleElemento(i).CKB_IND_MAC;
      Pr_DetalleElementoTmp(i).TXT_ARTICULO := Pr_DetalleElemento(i).TXT_ARTICULO;
      Pr_DetalleElementoTmp(i).TXT_DESC_ARTICULO := Pr_DetalleElemento(i).TXT_DESC_ARTICULO;
      Pr_DetalleElementoTmp(i).TXT_CODIGO_BODEGA := Pr_DetalleElemento(i).TXT_CODIGO_BODEGA;
      Pr_DetalleElementoTmp(i).TXT_DESC_BODEGA := Pr_DetalleElemento(i).TXT_DESC_BODEGA;
      Pr_DetalleElementoTmp(i).TXT_ASIGNADO_ARINME := Pr_DetalleElemento(i).TXT_ASIGNADO_ARINME;
      Pr_DetalleElementoTmp(i).TXT_CEDULA_ASIGNADO_RESPONSABL := Pr_DetalleElemento(i).TXT_CEDULA_ASIGNADO_RESPONSABL;
      Pr_DetalleElementoTmp(i).TXT_NO_CIA_RESPONSABLE := Pr_DetalleElemento(i).TXT_NO_CIA_RESPONSABLE;
      Pr_DetalleElementoTmp(i).CKB_ASIGNADO_CLIENTE := Pr_DetalleElemento(i).CKB_ASIGNADO_CLIENTE;
      Pr_DetalleElementoTmp(i).DETALLE_ELEMENTO_ID := Pr_DetalleElemento(i).DETALLE_ELEMENTO_ID;
    end loop;


    --
    DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('NAF',
                                         'P_PROCESAR.P_PROCESAR-03',
                                         'ANTES DEL P_PROCESAR@GPOETNET',
                                         NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.HOST),user), 
                                         SYSDATE,
                                         NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.IP_ADRESS),'127.0.0.1'));          
    --
   NAF47_TNET.INKG_RETIRO_EQUIPO.P_PROCESAR@GPOETNET (Pr_FiltroElementoTmp,
                                                      Pr_DetalleElementoTmp,
                                                      Pv_MensajeError);

    Pr_FiltroElemento.ID_DETALLE_SOLICITUD := Pr_FiltroElementoTmp.ID_DETALLE_SOLICITUD;
    Pr_FiltroElemento.TXT_LOGIN_EMPLE := Pr_FiltroElementoTmp.TXT_LOGIN_EMPLE;
    Pr_FiltroElemento.TXT_TECNICO := Pr_FiltroElementoTmp.TXT_TECNICO;
    Pr_FiltroElemento.TXT_NOCIA := Pr_FiltroElementoTmp.TXT_NOCIA;
    Pr_FiltroElemento.TXT_CENTRO := Pr_FiltroElementoTmp.TXT_CENTRO;
    Pr_FiltroElemento.REF_ASIGNADO_ID := Pr_FiltroElementoTmp.REF_ASIGNADO_ID;
    Pr_FiltroElemento.LOGIN := Pr_FiltroElementoTmp.LOGIN;
    Pr_FiltroElemento.TOTAL_ELEMENTO := Pr_FiltroElementoTmp.TOTAL_ELEMENTO;     

    for i in Pr_DetalleElementoTmp.first .. Pr_DetalleElementoTmp.last loop      
      Pr_DetalleElemento(i).TXT_NO_DOCU := Pr_DetalleElementoTmp(i).TXT_NO_DOCU;
      Pr_DetalleElemento(i).TXT_ESTADO := Pr_DetalleElementoTmp(i).TXT_ESTADO;
      Pr_DetalleElemento(i).SERIE_FISICA := Pr_DetalleElementoTmp(i).SERIE_FISICA;
      Pr_DetalleElemento(i).W_SERIE_FISICA := Pr_DetalleElementoTmp(i).W_SERIE_FISICA;
      Pr_DetalleElemento(i).MAC := Pr_DetalleElementoTmp(i).MAC;
      Pr_DetalleElemento(i).W_MAC := Pr_DetalleElementoTmp(i).W_MAC;
      Pr_DetalleElemento(i).ID_ELEMENTO := Pr_DetalleElementoTmp(i).ID_ELEMENTO;
      Pr_DetalleElemento(i).NOMBRE_TIPO_ELEMENTO := Pr_DetalleElementoTmp(i).NOMBRE_TIPO_ELEMENTO;
      Pr_DetalleElemento(i).NOMBRE_MODELO_ELEMENTO := Pr_DetalleElementoTmp(i).NOMBRE_MODELO_ELEMENTO;
      Pr_DetalleElemento(i).CKB_IND_MAC := Pr_DetalleElementoTmp(i).CKB_IND_MAC;
      Pr_DetalleElemento(i).TXT_ARTICULO := Pr_DetalleElementoTmp(i).TXT_ARTICULO;
      Pr_DetalleElemento(i).TXT_DESC_ARTICULO := Pr_DetalleElementoTmp(i).TXT_DESC_ARTICULO;
      Pr_DetalleElemento(i).TXT_CODIGO_BODEGA := Pr_DetalleElementoTmp(i).TXT_CODIGO_BODEGA;
      Pr_DetalleElemento(i).TXT_DESC_BODEGA := Pr_DetalleElementoTmp(i).TXT_DESC_BODEGA;
      Pr_DetalleElemento(i).TXT_ASIGNADO_ARINME := Pr_DetalleElementoTmp(i).TXT_ASIGNADO_ARINME;
      Pr_DetalleElemento(i).TXT_CEDULA_ASIGNADO_RESPONSABL := Pr_DetalleElementoTmp(i).TXT_CEDULA_ASIGNADO_RESPONSABL;
      Pr_DetalleElemento(i).TXT_NO_CIA_RESPONSABLE := Pr_DetalleElementoTmp(i).TXT_NO_CIA_RESPONSABLE;
      Pr_DetalleElemento(i).CKB_ASIGNADO_CLIENTE := Pr_DetalleElementoTmp(i).CKB_ASIGNADO_CLIENTE;
      Pr_DetalleElemento(i).DETALLE_ELEMENTO_ID := Pr_DetalleElementoTmp(i).DETALLE_ELEMENTO_ID;
    end loop; 

    --
    DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('NAF',
                                         'P_PROCESAR.P_PROCESAR-04',
                                         'DESPUÉS DEL P_PROCESAR@GPOETNET',
                                         NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.HOST),user), 
                                         SYSDATE,
                                         NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.IP_ADRESS),'127.0.0.1'));          
    --
  ...
  EXCEPTION
    WHEN Le_Error THEN
      --
      DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('NAF',
                                           'INKG_RETIRO_EQUIPO.P_PROCESAR-Le_Error',
                                           Pv_MensajeError,
                                           NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.HOST),user), 
                                           SYSDATE,
                                           NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.IP_ADRESS),'127.0.0.1'));
    ...
    WHEN OTHERS THEN
      ...
      --
      DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('NAF',
                                           'INKG_RETIRO_EQUIPO.P_PROCESAR-OTHERS',
                                           Pv_MensajeError,
                                           NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.HOST),user), 
                                           SYSDATE,
                                           NVL(SYS_CONTEXT(GEK_VAR.Gr_Sesion.USERENV,GEK_VAR.Gr_Sesion.IP_ADRESS),'127.0.0.1'));
