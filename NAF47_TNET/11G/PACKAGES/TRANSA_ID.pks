CREATE OR REPLACE PACKAGE NAF47_TNET.TRANSA_ID AS
...
CREATE OR REPLACE PACKAGE BODY NAF47_TNET.TRANSA_ID AS
  /*******[ PARTE: PRIVADA ]
  ...
  */
  ...
  BEGIN
    ...
    CLOSE c_seq;
    IF NOT vFound THEN
      --crea_secuencia_dinamica@gpoetnet(vnom_seq, verror);  
  ...
  BEGIN
    ...
    ELSE
      ...
      BEGIN
         ...
         --dbms_output.put_line('SELECT naf47_tnet.'||vnom_seq||'.NEXTVAL FROM DUAL');
