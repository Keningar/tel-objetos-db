CREATE OR REPLACE package NAF47_TNET.PRKG_CONTROL_PRESUPUESTO IS
...
CREATE OR REPLACE package body NAF47_TNET.PRKG_CONTROL_PRESUPUESTO is
  --
  ...
  BEGIN
    --
return naf47_tnet.PRKG_CONTROL_PRESUPUESTO.F_RECUPERA_CUENTA_CONTABLE@gpoetnet(Pv_TipoCosto => Pv_TipoCosto,
                                                                            Pv_ReferenciaId => Pv_ReferenciaId,
                                                                            Pv_EmpresaRefId => Pv_EmpresaRefId);
  ...
  BEGIN
    ...
    ELSE
      Ln_ResumenCostoId := NAF47_TNET.MIG_SECUENCIA.SEQ_PR_COSTOS_RESUMEN;
    END IF;
    --
  ...
  BEGIN
    ...
    --
    --
    Ln_IdCostoDetalleTrx := NAF47_TNET.MIG_SECUENCIA.SEQ_PR_COSTOS_DETALLE_TRX;
    --
    --
  ...
  BEGIN
    ...
    FOR Li_Datos IN 1..Pt_Detalle.LAST LOOP
      ...
      ELSE
        --
        Lr_CostoResumen.Id_Costo_Resumen := NAF47_TNET.MIG_SECUENCIA.SEQ_PR_COSTOS_RESUMEN;
        --
      ...
      END IF;
      Lr_CostoDetalleTrx.Id_Costo_Detalle_Trx :=NAF47_TNET.MIG_SECUENCIA.SEQ_PR_COSTOS_DETALLE_TRX;
