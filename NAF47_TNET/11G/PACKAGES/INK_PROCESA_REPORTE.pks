CREATE OR REPLACE package            INK_PROCESA_REPORTE is
  ...
  *
  * @author Luis Lindao <llindao@telconet.ec> 
  * @version 1.3  26/04/2022 - Se modifica para corregir referencia de de estructura TASGUSUARIO
  *
  **/
...
CREATE OR REPLACE package body            INK_PROCESA_REPORTE is
      ...
      open c_movimientos for
        select b.fecha,
               ...
               (select e.no_emple || ' - ' || e.nombre
                  from SEG47_TNET.TASGUSUARIO u, naf47_tnet.v_empleados_empresas e
