CREATE OR REPLACE PACKAGE            SRIK_PROCESA_DATOS_ATS IS
  /**
...
CREATE OR REPLACE PACKAGE BODY                       SRIK_PROCESA_DATOS_ATS IS
  --
  Ge_Error EXCEPTION;
  --
  --
  ...
  */
  ...
  BEGIN
    ...
    NAF47_TNET.SRIK_PROCESA_DATOS_ATS.P_GENERA_XML_ATS@GPOETNET ( Pv_NoCia,
                                                                  Pv_AnioProceso,
                                                                  Pv_MesProceso,
                                                                  Pv_MensajeError);
  ...
  */
  ...
  BEGIN
    ...
    NAF47_TNET.SRIK_PROCESA_DATOS_ATS.P_PROCESAR@GPOETNET( Pv_MesProceso,
                                                           Pv_AnioProceso,
                                                           Pv_NoCia,
                                                           Pv_MensajeError);
