CREATE OR REPLACE package            SRIK_CARGA_MASIVA_XML is
...
CREATE OR REPLACE package body            SRIK_CARGA_MASIVA_XML is
  ...
  FUNCTION F_OBTENER_SECUENCIA RETURN NUMBER IS
    LN_SEQ NUMBER;
  BEGIN
    SELECT NAF47_TNET.SEQ_INFO_CARGA_ARCHIVOS.NEXTVAL@GPOETNET
      INTO LN_SEQ
      FROM DUAL;
    RETURN LN_SEQ;
  END;
