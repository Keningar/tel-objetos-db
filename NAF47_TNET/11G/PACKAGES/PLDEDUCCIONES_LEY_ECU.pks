CREATE OR REPLACE PACKAGE            PLDEDUCCIONES_LEY_ECU IS
...
-- ---
   ...
   -- Devuelve los valores por el calculo del impuesto a la renta anual
...
END PLDEDUCCIONES_LEY_ECU;
/


CREATE OR REPLACE PACKAGE BODY            PLDEDUCCIONES_LEY_ECU IS
/*******[ PARTE: PRIVADA ]
