CREATE OR REPLACE PACKAGE NAF47_TNET.INKG_TRANSACCION IS
...
CREATE OR REPLACE PACKAGE BODY NAF47_TNET.INKG_TRANSACCION IS
  --
  ...
  PROCEDURE P_INSERTA_ARINMN ( Pr_Arinmn       IN     NAF47_TNET.ARINMN%ROWTYPE,
                               Pv_MensajeError IN OUT VARCHAR2) IS
   LN_CENTRO_COSTO                  VARCHAR2(09):=NAF47_TNET.CENTRO_COSTO.RELLENAD(Pr_Arinmn.No_Cia, NVL(Pr_Arinmn.centro_costo,'0'));                    
  BEGIN
   INSERT INTO ARINMN 
        ( NO_CIA,
          CENTRO,
 ...
 --
  ...
  PROCEDURE P_INSERTA_INFO_ELE_TRAZAB (Pr_InfoElementoTrazabilidad    IN DB_INFRAESTRUCTURA.INFO_ELEMENTO_TRAZABILIDAD%ROWTYPE,
                                       Pv_MensajeError IN OUT VARCHAR2)IS
    Ln_secuencia            number(19):=DB_INFRAESTRUCTURA.MIG_SECUENCIA.SEQ_INFO_ELEMENTO_TRAZABILIDAD;
  BEGIN
                    ...
                    */
                    IF Lb_GuardarCaracteristicasElem = TRUE AND
                      ...
                      IF Lo_CaracteristicaSerie.ID_CARACTERISTICA IS NOT NULL THEN
                        ...
                        VALUES
                          (DB_COMERCIAL.MIG_SECUENCIA.SEQ_INFO_DET_SOL_CARACT,
              ...
              IF Lv_CadenaElementosNoEntregados IS NOT NULL THEN
                ...
                INSERT INTO DB_COMERCIAL.INFO_DETALLE_SOL_HIST
                  (ID_SOLICITUD_HISTORIAL,
                   ...
                   ESTADO)
                VALUES
                  (DB_COMERCIAL.MIG_SECUENCIA.SEQ_INFO_DETALLE_SOL_HIST,
                   Lo_DetalleSolicitud.ID_DETALLE_SOLICITUD,
                   Lv_IpCreacion,
                   SYSDATE,
                   Lv_usrCreacion,
  ...
  BEGIN
     ...
     NAF47_TNET.INKG_TRANSACCION.P_AUDITORIA_ESTADO_ARTICULOS@GPOETNET(Pv_Serie,
                                          Pv_MensajeError);
/*
     Lv_Serie:=Pv_Serie;
     ...
     LOOP
        ...
        IF(Lb_Found)THEN
          ...
          VALUES(NAF47_TNET.MIG_SECUENCIA.SEQ_ARIN_ESTADO_ARTICULO,I.SERIE,I.COMPANIA,NULL,NULL,
          ...
          FOR Z IN C_INFORMACION(Lv_Serie) LOOP
            ...
            IF(Lb_Found)THEN
              INSERT INTO NAF47_TNET.ARIN_ESTADO_ARTICULO(ID_ESTADO_ARTICULO,SERIE,COMPANIA,ESTADO_ELEMENTO,FECHA_ELEMENTO,
                                                          ...
                                                          FECHA_SOLICITUD,ESTADO_SOLICITUD,
                                                          USR_CREACION,FE_CREACION,USR_MODIFICA,FE_MODIFICA,ESTADO_TRANSACCION)
              VALUES(NAF47_TNET.MIG_SECUENCIA.SEQ_ARIN_ESTADO_ARTICULO,Z.SERIE,Z.COMPANIA,Z.ESTADO_ELEMENTO,
            ...
            ELSE --Si existe solicitud de retiro
              ...
              LOOP
                INSERT INTO NAF47_TNET.ARIN_ESTADO_ARTICULO(ID_ESTADO_ARTICULO,SERIE,COMPANIA,ESTADO_ELEMENTO,FECHA_ELEMENTO,
                                                            ...
                                                            FECHA_SOLICITUD,ESTADO_SOLICITUD,
                                                            USR_CREACION,FE_CREACION,USR_MODIFICA,FE_MODIFICA,ESTADO_TRANSACCION)
                VALUES(NAF47_TNET.MIG_SECUENCIA.SEQ_ARIN_ESTADO_ARTICULO,J.SERIE,J.COMPANIA,J.ESTADO_ELEMENTO,
...
*/
  ...
  BEGIN
    ...
    VALUES(DB_COMERCIAL.MIG_SECUENCIA.SEQ_INFO_DETALLE_SOL_HIST,Lv_Solicitud,'AsignadoTarea',NULL,NULL,'Se actualiza el estado de Finalizada a AsignadoTarea mediante el proceso de reactivacion de solicitud de retiro.',
