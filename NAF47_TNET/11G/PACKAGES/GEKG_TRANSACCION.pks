CREATE OR REPLACE PACKAGE NAF47_TNET.GEKG_TRANSACCION IS
...
CREATE OR REPLACE PACKAGE BODY NAF47_TNET.GEKG_TRANSACCION IS
  ...
  BEGIN 
    ...
    INSERT INTO DB_SOPORTE.INFO_DETALLE (ID_DETALLE,TAREA_ID,OBSERVACION,
        ...
        VALUES (Ln_IdDetalle,Ln_IdTarea,Pv_ObsInfoDetalle,
                0,0, Ld_Fecha, 
                Ld_Fecha,LOWER(USER), /*GEK_CONSULTA.F_RECUPERA_LOGIN,  emunoz 11012023*/ GEK_CONSULTA.F_RECUPERA_IP,
     ...
     INSERT INTO DB_SOPORTE.INFO_CRITERIO_AFECTADO (ID_CRITERIO_AFECTADO, DETALLE_ID, CRITERIO,
        ...
        VALUES (Ln_IdCriterioAfectado,Ln_IdDetalle,'Clientes',
                Lv_Opcion,  LOWER(USER) /*GEK_CONSULTA.F_RECUPERA_LOGIN   emunoz 11012023*/,Ld_Fecha, GEK_CONSULTA.F_RECUPERA_IP);
      ...
      VALUES (Ln_IdParteAfectada,Ln_IdCriterioAfectado, Ln_IdDetalle, 
              ...
              Ld_Fecha,LOWER(USER) /*GEK_CONSULTA.F_RECUPERA_LOGIN   emunoz 11012023*/,Ld_Fecha,
   ...
   -- OPEN C_JEFE_OPERACIONES (Lr_Departamento.Nombre_Departamento,Lv_oficina, Lv_IndJefeDepto);
    ...
    INSERT INTO DB_SOPORTE.INFO_DETALLE_ASIGNACION (ID_DETALLE_ASIGNACION,DETALLE_ID,ASIGNADO_ID,
      ...
      VALUES(DB_SOPORTE.MIG_SECUENCIA.SEQ_INFO_DETALLE_ASIGNACION,Ln_IdDetalle,Lr_Departamento.ID_DEPARTAMENTO ,
             Lr_Departamento.NOMBRE_DEPARTAMENTO, Lr_Persona.ID_PERSONA,Lr_Persona.NOMBRE,
             Pv_ObsInfoDetalle,LOWER(USER)/* GEK_CONSULTA.F_RECUPERA_LOGIN   emunoz 11012033*/, Ld_Fecha,
    ...
    INSERT INTO DB_SOPORTE.INFO_TAREA_SEGUIMIENTO (ID_SEGUIMIENTO,DETALLE_ID,OBSERVACION,
      ...
      VALUES (DB_SOPORTE.MIG_SECUENCIA.SEQ_INFO_TAREA_SEGUIMIENTO, Ln_IdDetalle,'Tarea fue Asignada a '||Lr_Departamento.Nombre_Departamento,
             LOWER(USER) /*GEK_CONSULTA.F_RECUPERA_LOGIN  emunoz 11012023*/,Ld_Fecha, Pv_NoCia,Lv_Asignada,Lr_Departamento.ID_DEPARTAMENTO ,Ln_PersonaRol);
    ...
    INSERT INTO DB_SOPORTE.INFO_DETALLE_HISTORIAL (ID_DETALLE_HISTORIAL, DETALLE_ID, OBSERVACION, 
         ...
         VALUES(DB_SOPORTE.MIG_SECUENCIA.SEQ_INFO_DETALLE_HISTORIAL,Ln_IdDetalle,'Tarea fue Asignada a '||Lr_Departamento.Nombre_Departamento,
                Lv_Asignada,LOWER(USER)/*GEK_CONSULTA.F_RECUPERA_LOGIN   emunoz 11012023*/, Ld_Fecha,
   ...
   VALUES (Ln_IdDocumento,Lv_IdClaseDoc,'Registro de tarea',
           LOWER(USER)/*GEK_CONSULTA.F_RECUPERA_LOGIN  emunoz 11012023*/,Ld_Fecha,GEK_CONSULTA.F_RECUPERA_IP,
    ...
    INSERT INTO DB_COMUNICACION.INFO_DOCUMENTO_COMUNICACION
        VALUES (DB_COMUNICACION.MIG_SECUENCIA.SEQ_DOCUMENTO_COMUNICACION,Ln_IdDocumento,Ln_IdComunicacion,
               Lv_EstadoTarea,LOWER(USER)/*GEK_CONSULTA.F_RECUPERA_LOGIN   emunoz 11012023*/,Ld_Fecha,GEK_CONSULTA.F_RECUPERA_IP);

   IF C_ASIGNA%ISOPEN THEN CLOSE C_ASIGNA; END IF;
   --OPEN C_ASIGNA(GEK_CONSULTA.F_RECUPERA_LOGIN);     emunoz 11012023
   OPEN C_ASIGNA(LOWER(USER));                                ---emunoz 11012023
...
--
    ...
    WHEN Lex_Exception THEN
         ...
         DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('NAF',
                                              ...
                                              Pv_MensajeError,
                                              --GEK_CONSULTA.F_RECUPERA_LOGIN,     emunoz 11012022
                                              LOWER(USER),                                -- emunoz 11012023
                                              SYSDATE,
                                              GEK_CONSULTA.F_RECUPERA_IP);
