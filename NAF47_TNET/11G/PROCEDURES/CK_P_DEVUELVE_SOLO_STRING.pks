create or replace procedure            CK_P_DEVUELVE_SOLO_STRING(Pv_Cadena       in varchar2,
                                                      Pv_CadenaResult in out varchar2) is
  ...
  begin
    ...
    Pv_CadenaResult := lv_texto_acum;
  
end CK_P_DEVUELVE_SOLO_STRING;