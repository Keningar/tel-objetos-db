create or replace function            BARRAS_EAN(pbarras  varchar2)  return boolean  is
...
Begin
  ...
  --
  IF (largo_r = 8  OR largo_r = 13 OR largo_r = 14)  and  instr(PBARRAS,'-') = 0
                                                     and  instr(PBARRAS,'.') = 0 THEN
      pares_r    := 0;
      impares_r  := 0;
      mpares_r   := 0;
      mimpares_r := 0;
