/* Formatted on 5/2/2023 9:50:26 AM (QP5 v5.336) */
CREATE OR REPLACE FORCE VIEW NAF47_TNET.V_DEV_VENTAS_SRI
(
    NO_CIA,
    MES_ANIO,
    CEDULA,
...
AS
      SELECT a.no_cia,
             ...
             b.parte_relacionada,
             SUM (NVL (ABS (a.tot_lin), 0) - NVL (ABS (a.descuento), 0))
                 subtotal,
             SUM (ABS (a.impuesto))
                 iva,
             COUNT (*)
             ...
             'FA'
                 tipo,
             SUM (NVL (ABS (a.gravada), 0))
                 gravado,
             SUM (NVL (ABS (a.exento), 0))
                 exento
