CREATE FORCE EDITIONABLE VIEW "NAF47_TNET"."V_PRODUCTOS_STOCK" ("NO_CIA", "CENTRO", "ARTICULO", "OBSERVACION", "COSTO_UNI", "STOCK") AS 
  SELECT BA.NO_CIA,
           B.CENTRO,
           BA.NO_ARTI ARTICULO,
...
CREATE FORCE EDITIONABLE VIEW "NAF47_TNET"."V_DESCRIPCION_CARACTERISTICA" ("ID_CARACTERISTICA", "DESCRIPCION", "ESTADO") AS 
