CREATE EDITIONABLE TRIGGER NAF47_TNET.TR_EXCEDENTE_INSTALACIONES
  after insert
...
end TR_EXCEDENTE_INSTALACIONES;

/

ALTER TRIGGER "NAF47_TNET"."TR_EXCEDENTE_INSTALACIONES" ENABLE;

ALTER TRIGGER "NAF47_TNET"."TR_EXCEDENTE_INSTALACIONES" 
  COMPILE 
