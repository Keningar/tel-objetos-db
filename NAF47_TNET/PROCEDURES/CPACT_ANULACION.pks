 ...
 * @version 1.1 17/12/2019 Se modifica para considerar los nuevos campos de anulacion de comprobantes electronicos 
 *                         y anulacion de retenciones electronicas.
 * 
...
/*CREATE OR REPLACE PROCEDURE CPACT_HISTORICO
  ...
  */
  ...
  --
  -- si documento anular tiene retencion electronica, se debe anular en comprobantes
