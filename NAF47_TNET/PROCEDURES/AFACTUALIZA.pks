create or replace PROCEDURE                                             AFACTUALIZA ( pCia             arcgae.no_cia%type,
  ...
  Lv_LoginEmpleado            NAF47_TNET.LOGIN_EMPLEADO.LOGIN%TYPE := NAF47_TNET.GEK_CONSULTA.F_RECUPERA_LOGIN;
