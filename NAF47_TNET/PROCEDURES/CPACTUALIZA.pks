 ...
 * 
 * @author llindao <llindao@telconet.ec>
 * @version 1.2 05/07/2020 Se modifica invocar nuevo proceso PRKG_CONTROL_PRESUPUESTO para dsitribución de costos
 *
 * @author llindao <llindao@telconet.ec>
 * @version 1.3 27/08/2020 Se modifica invocar nuevo proceso PRKG_CONTROL_PRESUPUESTO.P_DISTRIBUCION_COSTO_FACTURA para dsitribución de costos
 *
 * @author llindao <llindao@telconet.ec>
