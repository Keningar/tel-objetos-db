BEGIN 
dbms_scheduler.create_job('"JOB_INA_VIGENCIA_PROMO_EN"',
...
'DECLARE
                                    ...
                                    BEGIN
                                      ...
                                      Lv_IdGrupos        := ''N'';
                                      Ln_IdMotivo        := ''0'';
                                      DB_COMERCIAL.CMKG_GRUPO_PROMOCIONES.P_CREA_PM_PROMOCIONES(Lv_IdGrupos,Ln_IdMotivo,Lv_Observacion,Lv_Usuario,''33'',Lv_IpCreacion,Lv_TipoPma,Lv_MsjResultado);
                                      DB_COMERCIAL.CMKG_GRUPO_PROMOCIONES.P_EJECUTA_PM_PROMOCIONES(''InactivaJob'',''InactivacionJob'',''33'',''Pendiente'');
                                     
                                    END;'
, number_of_arguments=>0,
start_date=>TO_TIMESTAMP_TZ('02-APR-2023 12.42.47.613821000 AM AMERICA/GUAYAQUIL','DD-MON-RRRR HH.MI.SSXFF AM TZR','NLS_DATE_LANGUAGE=english'), repeat_interval=> 
