BEGIN 
dbms_scheduler.create_job('"JOB_FINALIZA_PROMOCIONES_BW"',
job_type=>'PLSQL_BLOCK', job_action=>
'DECLARE
                                Lv_TipoProcesoQuitar  VARCHAR2(50) := ''QUITAR'';
                           BEGIN
                                DB_COMERCIAL.CMKG_PROMOCIONES_BW.P_EJECUTAR_PROMOCIONES_BW(Pv_Tipo => Lv_TipoProcesoQuitar);
                           END;'
