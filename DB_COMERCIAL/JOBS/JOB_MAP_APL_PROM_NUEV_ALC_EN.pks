BEGIN 
dbms_scheduler.create_job('"JOB_MAP_APL_PROM_NUEV_ALC_EN"',
...
start_date=>TO_TIMESTAMP_TZ('02-APR-2023 02.27.00.031786000 AM AMERICA/GUAYAQUIL','DD-MON-RRRR HH.MI.SSXFF AM TZR','NLS_DATE_LANGUAGE=english'), repeat_interval=> 
