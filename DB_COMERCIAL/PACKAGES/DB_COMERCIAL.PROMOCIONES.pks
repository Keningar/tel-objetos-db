CREATE OR REPLACE PACKAGE DB_COMERCIAL."PROMOCIONES" AS 
 ...
 /**
  * Documentación para PROCEDURE 'p_promociones_HOME'.
 ...
 *  En ambos casos se cambiara el estado de los puntos que tenga el referente a "Perdido" y se creará un registro
