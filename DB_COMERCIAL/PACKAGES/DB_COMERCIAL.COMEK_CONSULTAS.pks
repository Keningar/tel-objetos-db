CREATE OR REPLACE PACKAGE DB_COMERCIAL.COMEK_CONSULTAS AS
  ...
  * @version 1.8 29-09-2020 - Se modifica la consulta para presentar el valor de la instalación sin dividirla para el año.
  *
  */
  PROCEDURE P_GET_SUM_ORDENES_SERVICIO(Pv_PrefijoEmpresa      IN DB_COMERCIAL.INFO_EMPRESA_GRUPO.PREFIJO%TYPE,
    ...
    /**
     * Función que devuelve si un punto enviado por parámetro es un punto adicional.
     * Para determinar si es un punto adicional, se valida que existan más puntos dentro de la misma persona empresa rol y que el rol sea "Cliente".
    ...
    /**
     * Función que devuelve si un punto enviado por parámetro aplica la facturación de instalación según su tipo de origen.
     * Para determinar si aplica una factura es necesario obtener la característica TIPO_ORIGEN_TECNOLOGIA, el valor corresponde al ID_CARACTERISTICA
     * del punto. El cuál se encuentra en el parámetro COMBO_TIPO_ORIGEN_TECNOLOGIA_PUNTO y en el valor3 se encuentra la bandera si se factura o no.
     * @author Luis Cabrera <lcabrera@telconet.ec>
     * @version 1.0
     * @since 22-11-2018
     */
    ...
    /**
     * Función que devuelve la descripción del rol de una personaEmpresaRolId.
     * @author Luis Cabrera <lcabrera@telconet.ec>
     * @version 1.0
     * @since 22-11-2018
     */
    ...
    /**
     * Función que devuelve la información necesaria para poder generar las solicitudes de instalación.
     * @author Luis Cabrera <lcabrera@telconet.ec>
     * @version 1.0
     * @since 22-11-2018
     *
     ...
     * Se modifica CURSOR C_GetValorInstalacion para que obtenga el valor base de Instalación por Ultima milla FO, CO 
     * y Forma de Pago Efectivo     
     *
     * @author Hector Lozano <hlozano@telconet.ec>
     * @version 1.2
     * @since 27-02-2023  Se agrega parámetro CvEmpresaCod en el cursor C_GetDiasVigencia, para filtrar el resultado por empresa.  
     */
  ...
  *
  * @author Lizbeth Cruz <mlcruz@telconet.ec>
  * @version 1.3 06/08/2021 Se agrega la programación para autorizar servicios El canal del fútbol
  *
  * @author Jonathan Mazón Sánchez <jmazon@telconet.ec>
  * @version 1.4 28/09/2021 Se agrega mejora para autorizar servicios El canal del fútbol
  *
  ...
  */
   ...
   *
   * @param  Pv_CodigoEmpresa             IN VARCHAR2 Recibe el código de la empresa
   * @param  Pv_EstadoActualServicio      IN VARCHAR2 Recibe el estado actual del servicio
   * @param  Pn_DiasRechazo               IN NUMBER Recibe el número de días mínimos de un servicio en un estado determinado
  ...
  /**
  * Documentación para la función F_GET_DESCRIPCION_PRODUCTO.
  * Función que retorna la descripción de un producto 'INTERNET DEDICADO'.
  * Costo del Query C_getDescripcionProducto: 3
  *
  * @param  Fn_IdPlan                  DB_COMERCIAL.INFO_PLAN_CAB.ID_PLAN%TYPE => Id del plan.
  * @return DESCRIPCION_PRODUCTO       Retorna la descripción del producto.
 ...
 /**
  * Documentación para la función F_GET_VALOR_PLAN.
 ...
 /**
  * Documentación para el procedure P_SERVICIOS_MCAFEE_ERROR
  * Procedimiento que ejecuta un job para enviar notificación con clientes que presentaron
  * error al cancelar suscripción mcafee por migración de tecnología
  *
 ...
 /**
  * Documentación para el procedure P_SERVICIOS_KASPERSKY_ERROR
  * Procedimiento que ejecuta un job para enviar notificación con clientes que presentaron
  * error al cancelar suscripción kaspersky
  *
  * @author Lizbeth Cruz <mlcruz@telconet.ec>
 ...
 /**
  * Documentación para la función F_GET_FORMAS_CONTACTO_BY_PUNTO.
  * Función que retorna las formas de contacto de un punto.
  *
  * @param  Fn_IdPunto                DB_COMERCIAL.INFO_PUNTO.ID_PUNTO%TYPE => Id del punto.
  * @param  Fv_TipoData               DB_COMERCIAL.ADMI_FORMA_CONTACTO.CODIGO%TYPE => código de forma contacto.
...
FUNCTION F_GET_FORMAS_CONTACTO_BY_PUNTO(
 ...
 /**
  * Actualización: Se corrige query principal agregando "OR" faltante para 
  * consulta de estado de punto pendiente.
  *
  * @author Andrés Montero <amontero@telconet.ec>
  * @version 1.1 18-12-2019
  *
  * Documentación para la función GET_FORMAS_CONTACTO_BY_PUNTO.
  * Función que retorna las formas de contacto de un punto.
  *
  ...
  * @param  Pr_Informacion            OUT SYSREFCURSOR                                     => Resultado de los logins obtenidos según parámetros.
  * @author Andrés Montero <amontero@telconet.ec>
...
--
  ...
  *
  * @param  Pcl_Parametros         IN CLOB          Recibe los parámetros necesarios para realizar la consulta
  * @param  Pv_MensajeRespuesta    OUT VARCHAR2     Parametro usado para retornar obtener el mensaje de respuesta del procedimiento
  ...
  *
  * Funcion que retorna la cantidad de días y fecha del servicio
  *
 ...
 /**
  * Documentación para el procedimiento P_SERVICIO_POR_SERIE_ELEMENTO
  *
  * Método encargado de retornar el servicio del cual pertenece por la serie física del elemento
  *
 ...
 /**
  * Documentación para el procedimiento P_GET_SERVICIO_ACTIVAR_SERIE
  *
  * Método encargado de retornar los datos del servicio para activar la licencia de la serie del elemento
  *
  * @param Pv_Status      OUT  VARCHAR2 Retorna estatus de la transacción
  * @param Pv_Mensaje     OUT  VARCHAR2 Retorna mensaje de la transacción
  * @param Pcl_Response   OUT  SYS_REFCURSOR Retorna cursor de la transacción
 ...
 /**
  * Documentación para el procedimiento P_GET_SERVICIO_LICENCIA_RPA
  *
  * Método encargado de retornar los datos del servicio cancelado para la revisión de la licencia de la serie del elemento
  *
  * @param Pv_Status      OUT  VARCHAR2 Retorna estatus de la transacción
  * @param Pv_Mensaje     OUT  VARCHAR2 Retorna mensaje de la transacción
  * @param Pcl_Response   OUT  SYS_REFCURSOR Retorna cursor de la transacción
  ...
  */
  PROCEDURE P_GET_SERVICIO_LICENCIA_RPA(Pv_Status    OUT VARCHAR2,
   ...
   /**
  * Documentación para el procedimiento P_GET_SERVICIO_ENVIO_CORREO
  *
  * Método encargado de consultar y enviar correos de los datos del cliente/Pre-Cliente que realiza solicitud de Portabilidad
  *
  ...
  */
   ...
   /**
  * Documentación para el procedimiento P_ENVIO_CORREO_LOPDP
  *
  * Método encargado de  enviar correos de los datos del cliente que realiza solicitud de Oposicion
...
CREATE OR REPLACE PACKAGE BODY DB_COMERCIAL.COMEK_CONSULTAS AS
  ...
  --
    ...
    IS
        ...
        --Cursor que cuenta el total de puntos de la persona empresa rol según los estados parametrizados.
    ...
    BEGIN
        ...
        --Si tiene más de un punto ligado a la persona empresa rol, se verifica que ya sea "Cliente" para determinar que es un "PUNTO ADICIONAL"
    ...
    BEGIN
        ...
        IF Pv_EmpresaCod IS NULL OR Pv_DescripcionSolicitud IS NULL OR Pv_CaractContrato IS NULL OR Pv_NombreMotivo IS NULL THEN
            RAISE Le_Exception;
        END IF;       
        --Se obtiene el valor base a cobrar de instalación por FO, CO y forma de pago Efectivo
        ...
        END IF;
        --
        --Se obtiene el número de días de vigencia para el cálculo.
        ...
        CLOSE C_GetDiasVigencia;
        --Se calcula el número de días de vigencia.
        ...
        --Se obtiene la característica dependiendo del tipo de contrato
        ...
        --Se obtiene la característica de la fecha de vigencia.
  ...
  */
      ...
      ELSE
        ...
        IF Lr_VerificacionesAutorizacion.ID_PARAMETRO_DET IS NOT NULL THEN
          ...
          IF Lc_GetFechaCarctServicio%NOTFOUND THEN
            Pv_CodigoSalida  := '01';
            Pv_MensajeSalida := 'No se puede validar la fecha de cancelación del servicio';
            Raise Le_Error;
          END IF;
          ...
          IF Lc_GetFechaCarctServicio%NOTFOUND THEN
            Pv_CodigoSalida  := '01';
            Pv_MensajeSalida := 'No se puede validar la fecha de activación del servicio';
            Raise Le_Error;
          END IF;
  ...
  PROCEDURE P_SERVICIOS_MCAFEE_ERROR
    AS
      ...
      Lv_Asunto             VARCHAR2(300)  := 'Clientes con errores en cancelación de suscripciones MCAFEE por migración de tecnología';
  ...
  PROCEDURE P_SERVICIOS_KASPERSKY_ERROR
    AS
      ...
      Lv_SuscripcionesError VARCHAR2(4000);
      Lv_Remitente          VARCHAR2(50)   := 'notificaciones_telcos@telconet.ec';
      Lv_Asunto             VARCHAR2(300)  := 'Clientes con errores en cancelación de suscripciones KASPERSKY';
...
IS
  ...
  BEGIN
    ...
    ELSE
      --
      Lv_MensajeError := 'No se ha enviado los Parámetros adecuados para realizar la consulta - CodEmpresa(' ||
  ...
  AS
    ...
    BEGIN
        ...
        IF Ln_IdElemento IS NULL THEN
            Pv_Mensaje := 'No se encontró el elemento con la serie ' || Lv_SerieFisica || 
        ...
        IF Pv_Status = 'ERROR' THEN
            Pv_Mensaje := 'No se encontró el enlace relacionado del servicio con login auxiliar ' ||
        ...
        IF Ln_IdServicio IS NULL THEN
            Pv_Status := 'ERROR';
            Pv_Mensaje := 'No se encontró ningun servicio asociado a este elemento ' || Lv_NombreElemento ||
  ...
  BEGIN
    ...
    END IF;
        ...
        DBMS_LOB.APPEND(Lcl_Query,Lcl_QueryWhere);
            ...
            DB_GENERAL.GNKG_AS_XLSX.CELL(28,1,'AÑO_VENCIMIENTO');
