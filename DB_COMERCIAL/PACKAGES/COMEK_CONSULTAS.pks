CREATE OR REPLACE PACKAGE DB_COMERCIAL.COMEK_CONSULTAS AS
  ...
  *
  * @author Jos� Guam�n <jaguamanp@telconet.ec>
  ...
  * @version 1.8 29-09-2020 - Se modifica la consulta para presentar el valor de la instalaci�n sin dividirla para el a�o.
  *
  */
  PROCEDURE P_GET_SUM_ORDENES_SERVICIO(Pv_PrefijoEmpresa      IN DB_COMERCIAL.INFO_EMPRESA_GRUPO.PREFIJO%TYPE,
    ...
    /**
     * Funci�n que devuelve si un punto enviado por par�metro es un punto adicional.
     * Para determinar si es un punto adicional, se valida que existan m�s puntos dentro de la misma persona empresa rol y que el rol sea "Cliente".
    ...
    /**
     * Funci�n que devuelve si un punto enviado por par�metro aplica la facturaci�n de instalaci�n seg�n su tipo de origen.
     * Para determinar si aplica una factura es necesario obtener la caracter�stica TIPO_ORIGEN_TECNOLOGIA, el valor corresponde al ID_CARACTERISTICA
     * del punto. El cu�l se encuentra en el par�metro COMBO_TIPO_ORIGEN_TECNOLOGIA_PUNTO y en el valor3 se encuentra la bandera si se factura o no.
     * @author Luis Cabrera <lcabrera@telconet.ec>
     * @version 1.0
     * @since 22-11-2018
     */
    ...
    /**
     * Funci�n que devuelve la descripci�n del rol de una personaEmpresaRolId.
     * @author Luis Cabrera <lcabrera@telconet.ec>
     * @version 1.0
     * @since 22-11-2018
     */
    ...
    /**
     * Funci�n que devuelve la informaci�n necesaria para poder generar las solicitudes de instalaci�n.
     * @author Luis Cabrera <lcabrera@telconet.ec>
     * @version 1.0
     * @since 22-11-2018
     *
     ...
     * Se modifica CURSOR C_GetValorInstalacion para que obtenga el valor base de Instalaci�n por Ultima milla FO, CO 
     * y Forma de Pago Efectivo     
     *
     * @author Hector Lozano <hlozano@telconet.ec>
     * @version 1.2
     * @since 27-02-2023  Se agrega par�metro CvEmpresaCod en el cursor C_GetDiasVigencia, para filtrar el resultado por empresa.  
     */
  ...
  *
  * @author Lizbeth Cruz <mlcruz@telconet.ec>
  * @version 1.3 06/08/2021 Se agrega la programaci�n para autorizar servicios El canal del f�tbol
  *
  * @author Jonathan Maz�n S�nchez <jmazon@telconet.ec>
  * @version 1.4 28/09/2021 Se agrega mejora para autorizar servicios El canal del f�tbol
  *
  ...
  */
   ...
   *
   * @param  Pv_CodigoEmpresa             IN VARCHAR2 Recibe el c�digo de la empresa
   * @param  Pv_EstadoActualServicio      IN VARCHAR2 Recibe el estado actual del servicio
   * @param  Pn_DiasRechazo               IN NUMBER Recibe el n�mero de d�as m�nimos de un servicio en un estado determinado
  ...
  /**
  * Documentaci�n para la funci�n F_GET_DESCRIPCION_PRODUCTO.
  * Funci�n que retorna la descripci�n de un producto 'INTERNET DEDICADO'.
  * Costo del Query C_getDescripcionProducto: 3
  *
  * @param  Fn_IdPlan                  DB_COMERCIAL.INFO_PLAN_CAB.ID_PLAN%TYPE => Id del plan.
  * @return DESCRIPCION_PRODUCTO       Retorna la descripci�n del producto.
 ...
 /**
  * Documentaci�n para la funci�n F_GET_VALOR_PLAN.
 ...
 /**
  * Documentaci�n para el procedure P_SERVICIOS_MCAFEE_ERROR
  * Procedimiento que ejecuta un job para enviar notificaci�n con clientes que presentaron
  * error al cancelar suscripci�n mcafee por migraci�n de tecnolog�a
  *
 ...
 /**
  * Documentaci�n para el procedure P_SERVICIOS_KASPERSKY_ERROR
  * Procedimiento que ejecuta un job para enviar notificaci�n con clientes que presentaron
  * error al cancelar suscripci�n kaspersky
  *
  * @author Lizbeth Cruz <mlcruz@telconet.ec>
 ...
 /**
  * Documentaci�n para la funci�n F_GET_FORMAS_CONTACTO_BY_PUNTO.
  * Funci�n que retorna las formas de contacto de un punto.
  *
  * @param  Fn_IdPunto                DB_COMERCIAL.INFO_PUNTO.ID_PUNTO%TYPE => Id del punto.
  * @param  Fv_TipoData               DB_COMERCIAL.ADMI_FORMA_CONTACTO.CODIGO%TYPE => c�digo de forma contacto.
...
FUNCTION F_GET_FORMAS_CONTACTO_BY_PUNTO(
 ...
 /**
  * Actualizaci�n: Se corrige query principal agregando "OR" faltante para 
  * consulta de estado de punto pendiente.
  *
  * @author Andr�s Montero <amontero@telconet.ec>
  * @version 1.1 18-12-2019
  *
  * Documentaci�n para la funci�n GET_FORMAS_CONTACTO_BY_PUNTO.
  * Funci�n que retorna las formas de contacto de un punto.
  *
  ...
  * @param  Pr_Informacion            OUT SYSREFCURSOR                                     => Resultado de los logins obtenidos seg�n par�metros.
  * @author Andr�s Montero <amontero@telconet.ec>
...
--
  ...
  *
  * @param  Pcl_Parametros         IN CLOB          Recibe los par�metros necesarios para realizar la consulta
  * @param  Pv_MensajeRespuesta    OUT VARCHAR2     Parametro usado para retornar obtener el mensaje de respuesta del procedimiento
  ...
  *
  * Funcion que retorna la cantidad de d�as y fecha del servicio
  *
 ...
 /**
  * Documentaci�n para el procedimiento P_SERVICIO_POR_SERIE_ELEMENTO
  *
  * M�todo encargado de retornar el servicio del cual pertenece por la serie f�sica del elemento
  *
 ...
 /**
  * Documentaci�n para el procedimiento P_GET_SERVICIO_ACTIVAR_SERIE
  *
  * M�todo encargado de retornar los datos del servicio para activar la licencia de la serie del elemento
  *
  * @param Pv_Status      OUT  VARCHAR2 Retorna estatus de la transacci�n
  * @param Pv_Mensaje     OUT  VARCHAR2 Retorna mensaje de la transacci�n
  * @param Pcl_Response   OUT  SYS_REFCURSOR Retorna cursor de la transacci�n
 ...
 /**
  * Documentaci�n para el procedimiento P_GET_SERVICIO_LICENCIA_RPA
  *
  * M�todo encargado de retornar los datos del servicio cancelado para la revisi�n de la licencia de la serie del elemento
  *
  * @param Pv_Status      OUT  VARCHAR2 Retorna estatus de la transacci�n
  * @param Pv_Mensaje     OUT  VARCHAR2 Retorna mensaje de la transacci�n
  * @param Pcl_Response   OUT  SYS_REFCURSOR Retorna cursor de la transacci�n
  ...
  */
  PROCEDURE P_GET_SERVICIO_LICENCIA_RPA(Pv_Status    OUT VARCHAR2,
   ...
   /**
  * Documentaci�n para el procedimiento P_GET_SERVICIO_ENVIO_CORREO
  *
  * M�todo encargado de consultar y enviar correos de los datos del cliente/Pre-Cliente que realiza solicitud de Portabilidad
  *
  ...
  */
   ...
   /**
  * Documentaci�n para el procedimiento P_ENVIO_CORREO_LOPDP
  *
  * M�todo encargado de  enviar correos de los datos del cliente que realiza solicitud de Oposicion
...
CREATE OR REPLACE PACKAGE BODY DB_COMERCIAL.COMEK_CONSULTAS AS
  ...
  --
    ...
    IS
        ...
        --Cursor que cuenta el total de puntos de la persona empresa rol seg�n los estados parametrizados.
    ...
    BEGIN
        ...
        --Si tiene m�s de un punto ligado a la persona empresa rol, se verifica que ya sea "Cliente" para determinar que es un "PUNTO ADICIONAL"
    ...
    BEGIN
        ...
        IF Pv_EmpresaCod IS NULL OR Pv_DescripcionSolicitud IS NULL OR Pv_CaractContrato IS NULL OR Pv_NombreMotivo IS NULL THEN
            RAISE Le_Exception;
        END IF;       
        --Se obtiene el valor base a cobrar de instalaci�n por FO, CO y forma de pago Efectivo
        ...
        END IF;
        --
        --Se obtiene el n�mero de d�as de vigencia para el c�lculo.
        ...
        CLOSE C_GetDiasVigencia;
        --Se calcula el n�mero de d�as de vigencia.
        ...
        --Se obtiene la caracter�stica dependiendo del tipo de contrato
        ...
        --Se obtiene la caracter�stica de la fecha de vigencia.
  ...
  */
      ...
      ELSE
        ...
        IF Lr_VerificacionesAutorizacion.ID_PARAMETRO_DET IS NOT NULL THEN
          ...
          IF Lc_GetFechaCarctServicio%NOTFOUND THEN
            Pv_CodigoSalida  := '01';
            Pv_MensajeSalida := 'No se puede validar la fecha de cancelaci�n del servicio';
            Raise Le_Error;
          END IF;
          ...
          IF Lc_GetFechaCarctServicio%NOTFOUND THEN
            Pv_CodigoSalida  := '01';
            Pv_MensajeSalida := 'No se puede validar la fecha de activaci�n del servicio';
            Raise Le_Error;
          END IF;
  ...
  PROCEDURE P_SERVICIOS_MCAFEE_ERROR
    AS
      ...
      Lv_Asunto             VARCHAR2(300)  := 'Clientes con errores en cancelaci�n de suscripciones MCAFEE por migraci�n de tecnolog�a';
  ...
  PROCEDURE P_SERVICIOS_KASPERSKY_ERROR
    AS
      ...
      Lv_SuscripcionesError VARCHAR2(4000);
      Lv_Remitente          VARCHAR2(50)   := 'notificaciones_telcos@telconet.ec';
      Lv_Asunto             VARCHAR2(300)  := 'Clientes con errores en cancelaci�n de suscripciones KASPERSKY';
...
IS
  ...
  BEGIN
    ...
    ELSE
      --
      Lv_MensajeError := 'No se ha enviado los Par�metros adecuados para realizar la consulta - CodEmpresa(' ||
  ...
  AS
    ...
    BEGIN
        ...
        IF Ln_IdElemento IS NULL THEN
            Pv_Mensaje := 'No se encontr� el elemento con la serie ' || Lv_SerieFisica || 
        ...
        IF Pv_Status = 'ERROR' THEN
            Pv_Mensaje := 'No se encontr� el enlace relacionado del servicio con login auxiliar ' ||
        ...
        IF Ln_IdServicio IS NULL THEN
            Pv_Status := 'ERROR';
            Pv_Mensaje := 'No se encontr� ningun servicio asociado a este elemento ' || Lv_NombreElemento ||
  ...
  BEGIN
    ...
    END IF;
        ...
        DBMS_LOB.APPEND(Lcl_Query,Lcl_QueryWhere);
            ...
            DB_GENERAL.GNKG_AS_XLSX.CELL(28,1,'A�O_VENCIMIENTO');
...
PROCEDURE P_ENVIO_CORREO_LOPDP(Pv_Cliente           IN VARCHAR2,
  ...
  WHEN OTHERS THEN
    ...
    DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR(   'Telcos+', 'COMEK_CONSULTAS.P_ENVIO_CORREO_LOPDP', 
                                            'No se ha podido realizar el env�o del correo del cliente' || Pv_Cliente
