CREATE OR REPLACE PACKAGE DB_COMERCIAL.CMKG_PROMOCIONES_BW AS
  ...
  */   
  TYPE Lr_Punto_Promo_Procesar IS RECORD (    
  ...
  * @Param Pr_Punto_Promo  OUT Lr_Punto_Promo_Procesar         Devuelve el registro del punto
  *
  * @author Hector Lozano <hlozano@telconet.ec>
  * @version 1.0 8-08-2019
  */
  ...
  * @Param Pn_IdServicio          IN INFO_SERVICIO.ID_SERVICIO%TYPE                     Recibe el id del servicio
  * @Param Prf_TiposPromociones  OUT SYS_REFCURSOR                                      Devuelve las promociones Ancho de Banda
  *
  * @author Hector Lozano <hlozano@telconet.ec>
  * @version 1.0 6-08-2019
  *
  * @author Felix Caicedo <facaicedo@telconet.ec>
  * @version 1.1 26-01-2022 - Se realizan cambios en el proceso para el nuevo formato de promociones de ancho de banda.
  */
  ...
  * @Param Pn_IdPlanSuperior      OUT INFO_DETALLE_MAPEO_SOLICITUD.PLAN_ID_SUPERIOR%TYPE  Devuelve el id plan superior
  * @Param Pv_ConfiguraBW         OUT VARCHAR2                                            Devuelve 'SI/NO', si/no configura promo
  * @Param Pv_EstadoProceso       OUT VARCHAR2                                            Devuelve el estado del proceso
  * @Param Pv_Mensaje             OUT VARCHAR2                                            Devuelve un mensaje de respuesta
  *
  * @author Hector Lozano <hlozano@telconet.ec>
  ...
  * PARAMETROS:
  * @Param Pn_IdServicio           IN INFO_SERVICIO.ID_SERVICIO%TYPE        Recibe el id del servicio
  * @Param Pv_EstadoServicio       IN INFO_SERVICIO.ESTADO%TYPE             Recibe el estado del servicio
  * @Param Pa_ServiciosProcesar   OUT CMKG_PROMOCIONES.T_ServiciosProcesar  Devuelve una tabla con servicios a procesar
  *
  * @author Hector Lozano <hlozano@telconet.ec>
  ...
  *
  * @author Felix Caicedo <facaicedo@telconet.ec>
  * @version 1.1 12-02-2022 - Se valida si el tipo de proceso de la promo es por cambio de plan para el formato del historial
  */
  ...
  */
  TYPE Lr_ClientesPomoBw IS RECORD (
    ...
    ID_SERVICIO             DB_COMERCIAL.INFO_DETALLE_MAPEO_SOLICITUD.SERVICIO_ID%TYPE,
    ...
    ESTADO                  DB_COMERCIAL.INFO_DETALLE_MAPEO_SOLICITUD.ESTADO%TYPE
  );
  ...
  * Costo del Query C_IpsPorPlan: 11
  *
  * PARAMETROS:
  ...
  */                 
   ...
   */
  TYPE T_RegPromoExterno IS TABLE OF DB_EXTERNO.INFO_PROCESO_PROMO%ROWTYPE INDEX BY PLS_INTEGER;

----
----
----PARTE 2 CAB (PROCESO MASIVO DE APLICA ANCHO DE BANDA)
----
----
  ...
  TYPE Gr_ClientesPromo IS RECORD (
    ...
    PLAN_ID         DB_COMERCIAL.INFO_SERVICIO.PLAN_ID%TYPE,
  ...
  */
  TYPE Gr_ProcesoPromo IS RECORD (
    EMPRESA_COD       VARCHAR2(10),
    SERVICIO_ID       NUMBER,
  ...
  TYPE Gr_Caracteristica IS RECORD (
    ...
    VALOR           DB_INFRAESTRUCTURA.INFO_DETALLE_ELEMENTO.DETALLE_VALOR%TYPE
  );
   ...
   * Costo Query C_PlanCaracUltraV : 5.
   ...
   *
   * @author Felix Caicedo <facaicedo@telconet.ec>
   * @version 1.1 29-04-2022 - Se recibe el json y se retorna la respuesta inmediatamente,
   *                           se genera una tarea programada para procesar las promociones.
   */
   ...
   *
   * @author Felix Caicedo <facaicedo@telconet.ec>
   * @version 1.1 25-04-2022 - Se mejora el proceso para obtener los registros.
   */
   ...
   * @Param Pv_EstadoProceso  IN VARCHAR2   - estado proceso
   * @Param Pv_Tecnologia     IN VARCHAR2   - tecnologia
   *
   * @author Felix Caicedo <facaicedo@telconet.ec>
   ...
   *
   * PARAMETROS:
   * @Param Pn_IdSolicitud IN NUMBER - Id de la solicitud
   *
   * @author Felix Caicedo <facaicedo@telconet.ec>
