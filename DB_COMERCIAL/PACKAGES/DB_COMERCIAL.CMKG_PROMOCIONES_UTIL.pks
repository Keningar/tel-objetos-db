...
----
  ...
  BEGIN  
    DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('Telcos', 
                                             ...
                                             'Inicio proceso P_PROMOCION_EVALUA_TENTATIVA PuntoId: '||Pn_IdPunto, 
                                             'telcos_mapeo_promo',
                                             SYSDATE,
                                             NVL(SYS_CONTEXT('USERENV','IP_ADDRESS'), Lv_IpCreacion));
    Lv_EsCodigo := 'S';
    ...
    DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('Telcos', 
                                             'CMKG_PROMOCIONES_UTIL.P_PROMOCION_TENTATIVA', 
                                             'Inicio proceso P_OBTIENE_SERVICIOS_PUNTO PuntoId: '||Pn_IdPunto, 
                                             'telcos_mapeo_promo',
                                             SYSDATE,
                                             NVL(SYS_CONTEXT('USERENV','IP_ADDRESS'), Lv_IpCreacion));
    ...
    IF La_ServiciosProcesar.COUNT > 0 THEN
        ...
        DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('Telcos', 
                                                 'CMKG_PROMOCIONES_UTIL.P_PROMOCION_TENTATIVA', 
                                                 'Inicio proceso 2 P_PROMOCION_EVALUA_TENTATIVA PuntoId: '||Pn_IdPunto, 
                                                 'telcos_mapeo_promo',
                                                 SYSDATE,
                                                 NVL(SYS_CONTEXT('USERENV','IP_ADDRESS'), Lv_IpCreacion));
    ...
    DB_GENERAL.GNRLPCK_UTIL.INSERT_ERROR('Telcos', 
                                             'CMKG_PROMOCIONES_UTIL.P_PROMOCION_TENTATIVA', 
                                             'Fin proceso tentativa PuntoId: '||Pn_IdPunto, 
                                             'telcos_mapeo_promo',
                                             SYSDATE,
                                             NVL(SYS_CONTEXT('USERENV','IP_ADDRESS'), Lv_IpCreacion));
    Pv_Status     := Lv_Status;
