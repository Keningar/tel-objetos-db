CREATE OR REPLACE TRIGGER DB_COMERCIAL.BEFORE_INFO_SERVICIO_REC_DET
  BEFORE UPDATE ON DB_COMERCIAL.INFO_SERVICIO_RECURSO_DET FOR EACH ROW

  /**
   * Documentación para el trigger BEFORE_INFO_SERVICIO_REC_DET'.
