CREATE OR REPLACE TRIGGER DB_COMERCIAL.BEFORE_INFO_SOLUCION_REF
  BEFORE UPDATE ON DB_COMERCIAL.INFO_SOLUCION_REFERENCIA FOR EACH ROW

  /**
   * Documentación para el trigger BEFORE_INFO_SOLUCION_REF'.
