    ...
    DBMS_LOB.APPEND(bada, '
       ...
       <div id="contenedor" class="col-width-100" style="font-size:14px;">
         <table class="col-width-100">         
           <tr>     
             <td class="col-width-75" style="font-size:12px;"><b>CONTRATO DE ADHESIÓN DE PRESTACIÓN DE SERVICIOS</b></td> 
           ...
           <tr style="$!verLeyenda">
            <td class="col-width-75" style="font-size:14px;">FE DE ERRATAS: este contrato es emitido como corrección del contrato $!numeroContrato</td>
          </tr>
         ...
         <div id="contenedor" class="col-width-100" >
             ...
             <div id="row">
                 <div id="col" class="col-width-15"><b>Actividad Económica:</b></div>
                 <div id="col" class="col-width-45 labelGris">
         ...
         <div id="contenedor" class="col-width-100" >
             <div id="row">
                 ...
                 <div id="col" class="col-width-80" style="font-style: oblique; padding-top: 5px;">Formato: Calle Principal,Numeración,Calle Secundaria,Nombre Edficio o Conjunto,Piso,Numero
    ...
    DBMS_LOB.APPEND(bada, '
        ...
        <div style="width:36%; float:left; vertical-align:top;" >
            ...
            <table class="box-section-content col-width-100 borderTable" style="border-collapse:collapse;border-spacing:0;">
                ...
                <tr class="avoid">
                    <td class="col-width-10 line-heightT textCenter" style="font-size: 9px;" rowspan="2" colspan="3">Acepto los beneficios de promociones vinculados con la cláusula 11 de tiempo mínimo de permanencia.</td>
        ...
        <div id="contenedor" class="col-width-100">
            <div id="row">
                ...
                <div id="col" class="col-width-25">
                    <div class="box-label" style="font-size:9px">Tarjeta de Crédito</div>
