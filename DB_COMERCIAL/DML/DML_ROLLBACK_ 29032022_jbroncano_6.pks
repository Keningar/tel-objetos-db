...
SET HTML=EMPTY_CLOB()
where COD_PLANTILLA = 'terminosCondicionesMegadatos';

DBMS_LOB.APPEND(bada, '
<!DOCTYPE html>
<html>
	<head>
		<title>Tárminos y Condiciones - Netlife</title>
   	...
   	<body   onload="substitutePdfVariables()">
		...
		<div style="text-align: justify;">
            <span>
                ...
                <br/>
                <li>Los servicios adicionales generan una facturación proporcional al momento de la contratación y luego será de forma recurrente. El servicio adicional estará activo mientras el cliente está al día en pagos, caso contrario no podrá acceder al mismo por estar suspendido.</li>
                <br/>
                </ul> 
                <br/>
               </div>   
            ...
            <div id="row">
                <div id="colCell" class="col-width-50" style="text-align:center">
                    <div id="contenedor" class="col-width-100">
                        ...
                        <div id="row">
                            <div id="colCell" class="col-width-25"></div>
                            <div id="colCell" class="col-width-50"><span>MEGADATOS</span><input id="inputfirma1" name="FIRMA_TERMINOS_MD_EMPRESA" type="text" value="hahahah" style="background-color:#fff; width:0.0em; margin-left:0.75em; border-style: hidden; opacity:0; border:none;" readonly/></div>
                            <div id="colCell" class="col-width-25"></div>
                        </div>
                    </div>
                </div>
                <div id="colCell" class="col-width-50" style="text-align:center">
                    <div id="contenedor" class="col-width-100">
                        ...
                        <div id="row">
                            <div id="colCell" class="col-width-25"></div>
                            <div id="colCell" class="col-width-50"><span>Firma del Cliente</span><input id="inputfirma2" name="FIRMA_TERMINOS_MD_CLIENTE" type="text" value="jssjsjsjsjs" style="background-color:#fff; width:0.0em; margin-left:0.75em; border-style: hidden; opacity:0; border:none;" readonly/></div>
                            <div id="colCell" class="col-width-25"></div>
                        </div>
                    </div>
                </div>
