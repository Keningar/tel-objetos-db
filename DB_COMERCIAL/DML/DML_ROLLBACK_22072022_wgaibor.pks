...
<html>
	<head>
		<title>Términos y Condiciones - Netlife</title>
...
DBMS_LOB.APPEND(bada, '
   	<body style="$!fontSize" onload="substitutePdfVariables()">
		...
		<div style="text-align: justify; $!fontSize">
            <span>
                ...
                <div class="clausulas" style="text-align: justify; $!fontSize">
	 ...
	 <!-- ========================================== -->        <!-- Firmas -->
        ...
        <div id="contenedor" class="col-width-100">
            <div id="row">
                <div id="colCell" class="col-width-50" style="text-align:right $!fontSize"> $!versionFecha</div>
            </div>
        </div>
