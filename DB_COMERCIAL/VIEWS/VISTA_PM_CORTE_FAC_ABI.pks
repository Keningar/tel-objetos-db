CREATE   OR REPLACE VIEW "DB_COMERCIAL"."VISTA_PM_CORTE_FAC_ABI" ("ID_PERSONA", "NOMBRE_CLIENTE", "EMPRESA_COD", "ID_OFICINA", "NOMBRE_OFICINA", "ID_PUNTO", "LOGIN", "ID_TIPO_NEGOCIO", "NOMBRE_TIPO_NEGOCIO", "ID_FORMA_PAGO", "DESCRIPCION_FORMA_PAGO", "SALDO", "ULTIMA_MILLA", "BANCO_ID", "DESCRIPCION_BANCO", "TIPO_CUENTA_ID", "DESCRIPCION_CUENTA", "ES_TARJETA", "ROL", "CICLO_ID") AS 
  SELECT DISTINCT 
    PERSONA.ID_PERSONA,
    CASE
    ...
    (
      ...
      CASE
      WHEN (EMPRESA_ROL.EMPRESA_COD) = '18' OR (EMPRESA_ROL.EMPRESA_COD) = '33'
  ...
  (
    ...
    WHERE CAB.ESTADO IN (
      ...
      WHERE PARAM_CAB.NOMBRE_PARAMETRO = 'PARAMETROS_ASOCIADOS_A_SERVICIOS_MD'
      AND PARAM_CAB.ESTADO = 'Activo'
      AND PARAM_DET.VALOR1 = 'CORTE_MASIVO'
      AND PARAM_DET.VALOR2 = 'FILTROS_REGISTROS_PM_NO_PERMITIDOS'
      AND PARAM_DET.VALOR3 = 'ESTADOS_INFO_PROCESO_MASIVO_CAB'
    ...
    AND CAB.TIPO_PROCESO IN (
      ...
      AND PARAM_DET.VALOR1 = 'CORTE_MASIVO'
      AND PARAM_DET.VALOR2 = 'FILTROS_REGISTROS_PM_NO_PERMITIDOS'
      AND PARAM_DET.VALOR3 = 'TIPOS_PROCESO_INFO_PROCESO_MASIVO_CAB'
      AND PARAM_DET.ESTADO = 'Activo'
    )
    AND DET.ESTADO IN (
      SELECT PARAM_DET.VALOR4
      ...
      AND PARAM_DET.VALOR1 = 'CORTE_MASIVO'
      AND PARAM_DET.VALOR2 = 'FILTROS_REGISTROS_PM_NO_PERMITIDOS'
      AND PARAM_DET.VALOR3 = 'ESTADOS_INFO_PROCESO_MASIVO_DET'
      AND PARAM_DET.ESTADO = 'Activo'
    )
