CREATE   OR REPLACE VIEW "DB_COMERCIAL"."V_SEGURIDAD_ECUCERT" ("ID_SERVICIO", "FECHA_ACTIVACION", "ESTADO", "RAZON_SOCIAL_CLIENTE", "LOGIN", "LOGIN_AUX", "GRUPO", "PRODUCTO", "TIPO_ENLACE", "TIPO_MEDIO", "CAPACIDAD_KB", "NOMBRE_ELEMENTO", "NOMBRE_INTERFACE_ELEMENTO", "IP", "TIPO_IP", "MASCARA", "SUBRED", "NOMBRE_PE", "NOMBRE_RUTA", "RED_LAN", "MASCARA_RED_LAN", "TIPO_RED", "PUNTO_COBERTURA", "CONTACTO_TECNICO", "TIENE_ASIGNADO_VIP", "INGENIERO_VIP", "SERVICIOS_GESTIONADOS", "EMPRESA") AS 
  SELECT 
